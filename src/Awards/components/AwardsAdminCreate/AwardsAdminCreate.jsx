...
class AwardsAdminCreate extends PureComponent {
  render() {
...
AwardsAdminCreate.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
AwardsAdminCreate.displayName = 'AwardsAdminCreate';

export default AwardsAdminCreate;
