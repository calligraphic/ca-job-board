...
// Component import
import AwardsAdminCreate from './AwardsAdminCreate';
import AwardsAdminCreateReadme from './AwardsAdminCreate.README.md';
...
const WrappedAwardsAdminCreate = StorybookComponentWrapperHOC(
  AwardsAdminCreate
);

// React render function
const AwardsAdminCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAwardsAdminCreate />
    </State>
  );
};
...
storiesOf('Awards', module)
  ...
  .addWithChapters('Awards Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AwardsAdminCreateReadme,
            sectionFn: AwardsAdminCreatePreviewRenderer
          }
        ]
      }
    ]
