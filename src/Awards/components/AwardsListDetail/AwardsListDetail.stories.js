...
// Component import
import AwardsListDetail from './AwardsListDetail';
import AwardsListDetailReadme from './AwardsListDetail.README.md';
...
const WrappedAwardsListDetail = StorybookComponentWrapperHOC(AwardsListDetail);

// React render function
const AwardsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAwardsListDetail />
    </State>
  );
};

storiesOf('Awards', module)
  .addDecorator(withKnobs)
  .addDecorator((story, context) =>
    withNotes(notesPanelContent)(story)(context)
  )
  .addWithChapters('Awards List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AwardsListDetailReadme,
            sectionFn: AwardsListDetailPreviewRenderer
          }
        ]
      }
    ]
