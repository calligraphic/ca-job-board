...
// Component import
import AwardsAdminEdit from './AwardsAdminEdit';
import AwardsAdminEditReadme from './AwardsAdminEdit.README.md';
...
const WrappedAwardsAdminEdit = StorybookComponentWrapperHOC(AwardsAdminEdit);

// React render function
const AwardsAdminEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAwardsAdminEdit />
    </State>
  );
};
...
storiesOf('Awards', module)
  ...
  .addWithChapters('Awards Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AwardsAdminEditReadme,
            sectionFn: AwardsAdminEditPreviewRenderer
          }
        ]
      }
    ]
