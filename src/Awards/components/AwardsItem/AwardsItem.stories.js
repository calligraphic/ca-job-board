...
import AwardsItemReadme from './AwardsItem.README.md';
...
const WrappedAwardsItem = StorybookComponentWrapperHOC(AwardsItem);

// React render function
const AwardsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAwardsItem />
    </State>
...
storiesOf('Awards', module)
  ...
  .addWithChapters('Awards Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AwardsItemReadme,
            sectionFn: AwardsItemPreviewRenderer
          }
        ]
      }
    ]
