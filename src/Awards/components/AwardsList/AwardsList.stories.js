...
import AwardsListReadme from './AwardsList.README.md';
...
const WrappedAwardsList = StorybookComponentWrapperHOC(AwardsList);

// React render function
const AwardsListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAwardsList />
    </State>
...
storiesOf('Awards', module)
  ...
  .addWithChapters('Awards List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AwardsListReadme,
            sectionFn: AwardsListPreviewRenderer
          }
        ]
      }
    ]
