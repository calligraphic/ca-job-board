...
// Component import
import AwardsAdminConfig from './AwardsAdminConfig';
import AwardsAdminConfigReadme from './AwardsAdminConfig.README.md';
...
const WrappedAwardsAdminConfig = StorybookComponentWrapperHOC(
  AwardsAdminConfig
);

// React render function
const AwardsAdminConfigPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAwardsAdminConfig />
    </State>
  );
};
...
storiesOf('Awards', module)
  ...
  .addWithChapters('Awards Admin Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AwardsAdminConfigReadme,
            sectionFn: AwardsAdminConfigPreviewRenderer
          }
        ]
      }
    ]
