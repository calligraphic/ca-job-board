...
class AwardsAdminConfig extends PureComponent {
  render() {
...
AwardsAdminConfig.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
AwardsAdminConfig.displayName = 'AwardsAdminConfig';

export default AwardsAdminConfig;
