...
import HomePageReadme from './HomePage.README.md';
...
const WrappedHomePage = StorybookComponentWrapperHOC(HomePage);

// React render function
const HomePagePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedHomePage />
    </State>
...
storiesOf('Home Page', module)
  ...
  .addWithChapters('Home Page View', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            ...
            subtitle: null,
            info: HomePageReadme,
            sectionFn: HomePagePreviewRenderer
          }
        ]
      }
    ]
