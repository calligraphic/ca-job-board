...
// Component import
import ConnectorProgramCreate from './ConnectorProgramCreate';
import ConnectorProgramCreateReadme from './ConnectorProgramCreate.README.md';
...
const WrappedConnectorProgramCreate = StorybookComponentWrapperHOC(
  ConnectorProgramCreate
);

// React render function
const ConnectorProgramCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedConnectorProgramCreate />
    </State>
  );
};
...
storiesOf('Connector Program', module)
  ...
  .addWithChapters('Connector Program Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ConnectorProgramCreateReadme,
            sectionFn: ConnectorProgramCreatePreviewRenderer
          }
        ]
      }
    ]
