...
class ConnectorProgramCreate extends PureComponent {
  render() {
...
ConnectorProgramCreate.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ConnectorProgramCreate.displayName = 'ConnectorProgramCreate';

export default ConnectorProgramCreate;
