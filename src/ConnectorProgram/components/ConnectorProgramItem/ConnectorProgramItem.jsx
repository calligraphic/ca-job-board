...
class ConnectorProgramItem extends PureComponent {
  render() {
...
ConnectorProgramItem.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ConnectorProgramItem.displayName = 'ConnectorProgramItem';

export default ConnectorProgramItem;
