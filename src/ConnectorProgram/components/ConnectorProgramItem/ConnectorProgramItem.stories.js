...
// Component import
import ConnectorProgramItem from './ConnectorProgramItem';
import ConnectorProgramItemReadme from './ConnectorProgramItem.README.md';
...
const WrappedConnectorProgramItem = StorybookComponentWrapperHOC(
  ConnectorProgramItem
);

// React render function
const ConnectorProgramItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedConnectorProgramItem />
    </State>
  );
};
...
storiesOf('Connector Program', module)
  ...
  .addWithChapters('Connector Program Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ConnectorProgramItemReadme,
            sectionFn: ConnectorProgramItemPreviewRenderer
          }
        ]
      }
    ]
