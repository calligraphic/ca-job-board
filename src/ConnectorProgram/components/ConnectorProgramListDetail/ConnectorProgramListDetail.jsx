...
class ConnectorProgramListDetail extends PureComponent {
  render() {
...
ConnectorProgramListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ConnectorProgramListDetail.displayName = 'ConnectorProgramListDetail';

export default ConnectorProgramListDetail;
