...
class ConnectorProgramEdit extends PureComponent {
  render() {
...
ConnectorProgramEdit.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ConnectorProgramEdit.displayName = 'ConnectorProgramEdit';

export default ConnectorProgramEdit;
