...
class ConnectorProgramList extends PureComponent {
  render() {
...
ConnectorProgramList.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ConnectorProgramList.displayName = 'ConnectorProgramList';

export default ConnectorProgramList;
