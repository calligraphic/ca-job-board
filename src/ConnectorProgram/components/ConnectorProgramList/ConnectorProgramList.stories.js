...
// Component import
import ConnectorProgramList from './ConnectorProgramList';
import ConnectorProgramListReadme from './ConnectorProgramList.README.md';
...
const WrappedConnectorProgramList = StorybookComponentWrapperHOC(
  ConnectorProgramList
);

// React render function
const ConnectorProgramListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedConnectorProgramList />
    </State>
  );
};
...
storiesOf('Connector Program', module)
  ...
  .addWithChapters('Connector Program List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ConnectorProgramListReadme,
            sectionFn: ConnectorProgramListPreviewRenderer
          }
        ]
      }
    ]
