...
import EmailMarketingReadme from './EmailMarketing.README.md';
...
const WrappedEmailMarketing = StorybookComponentWrapperHOC(EmailMarketing);

// React render function
const EmailMarketingPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmailMarketing />
    </State>
  );
};
...
storiesOf('Email', module)
  ...
  .addWithChapters('Email Marketing Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmailMarketingReadme,
            sectionFn: EmailMarketingPreviewRenderer
          }
        ]
      }
    ]
