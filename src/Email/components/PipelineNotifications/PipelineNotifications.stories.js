...
import PipelineNotificationsReadme from './PipelineNotifications.README.md';
...
const WrappedPipelineNotifications = StorybookComponentWrapperHOC(
  PipelineNotifications
);

// React render function
const PipelineNotificationsPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedPipelineNotifications />
    </State>
  );
};
...
storiesOf('Email', module)
  ...
  .addWithChapters('Pipeline Notifications List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: PipelineNotificationsReadme,
            sectionFn: PipelineNotificationsPreviewRenderer
          }
        ]
      }
    ]
