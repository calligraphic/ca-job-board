...
// Component import
import SocialMediaPush from './SocialMediaPush';
import SocialMediaPushReadme from './SocialMediaPush.README.md';
...
const WrappedSocialMediaPush = StorybookComponentWrapperHOC(SocialMediaPush);

// React render function
const SocialMediaPushPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSocialMediaPush />
    </State>
  );
};
...
storiesOf('Admin', module)
  ...
  .addWithChapters('Social Media Push', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SocialMediaPushReadme,
            sectionFn: SocialMediaPushPreviewRenderer
          }
        ]
      }
    ]
