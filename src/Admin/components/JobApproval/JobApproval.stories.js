...
import JobApprovalReadme from './JobApproval.README.md';
...
const WrappedJobApproval = StorybookComponentWrapperHOC(JobApproval);

// React render function
const JobApprovalPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobApproval />
    </State>
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobApprovalReadme,
            sectionFn: JobApprovalPreviewRenderer
          }
        ]
      }
    ]
