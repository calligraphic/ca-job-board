...
// Component import
import FeedGeneratorRSS from './FeedGeneratorRSS';
import FeedGeneratorRSSReadme from './FeedGeneratorRSS.README.md';
...
const WrappedFeedGeneratorRSS = StorybookComponentWrapperHOC(FeedGeneratorRSS);

// React render function
const FeedGeneratorRSSPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedFeedGeneratorRSS />
    </State>
  );
};
...
storiesOf('Admin', module)
  ...
  .addWithChapters('RSS Feed Generator', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: FeedGeneratorRSSReadme,
            sectionFn: FeedGeneratorRSSPreviewRenderer
          }
        ]
      }
    ]
