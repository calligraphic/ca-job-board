...
// Component import
import CandidatesCreate from './CandidatesCreate';
import CandidatesCreateReadme from './CandidatesCreate.README.md';
...
const WrappedCandidatesCreate = StorybookComponentWrapperHOC(CandidatesCreate);

// React render function
const CandidatesCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCandidatesCreate />
    </State>
  );
};

storiesOf('Candidates', module)
  .addDecorator(withKnobs)
  .addDecorator((story, context) =>
    withNotes(notesPanelContent)(story)(context)
  )
  .addWithChapters('Candidates Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CandidatesCreateReadme,
            sectionFn: CandidatesCreatePreviewRenderer
          }
        ]
      }
    ]
