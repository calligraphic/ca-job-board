...
import CandidatesListReadme from './CandidatesList.README.md';
...
const WrappedCandidatesList = StorybookComponentWrapperHOC(CandidatesList);

// React render function
const CandidatesListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCandidatesList />
    </State>
  );
};
...
storiesOf('Candidates', module)
  ...
  .addWithChapters('Candidates List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CandidatesListReadme,
            sectionFn: CandidatesListPreviewRenderer
          }
        ]
      }
    ]
