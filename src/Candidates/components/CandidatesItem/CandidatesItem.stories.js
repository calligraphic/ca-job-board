...
import CandidatesItemReadme from './CandidatesItem.README.md';
...
const WrappedCandidatesItem = StorybookComponentWrapperHOC(CandidatesItem);

// React render function
const CandidatesItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCandidatesItem />
    </State>
  );
};
...
storiesOf('Candidates', module)
  ...
  .addWithChapters('Candidates Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CandidatesItemReadme,
            sectionFn: CandidatesItemPreviewRenderer
          }
        ]
      }
    ]
