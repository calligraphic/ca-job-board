...
class CandidatesListDetail extends PureComponent {
  render() {
...
CandidatesListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
CandidatesListDetail.displayName = 'CandidatesListDetail';

export default CandidatesListDetail;
