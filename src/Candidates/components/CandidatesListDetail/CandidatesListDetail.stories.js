...
import CandidatesListDetailReadme from './CandidatesListDetail.README.md';
...
const WrappedCandidatesListDetail = StorybookComponentWrapperHOC(
  CandidatesListDetail
);

// React render function
const CandidatesListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCandidatesListDetail />
    </State>
  );
};
...
storiesOf('Candidates', module)
  ...
  .addWithChapters('Candidates List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CandidatesListDetailReadme,
            sectionFn: CandidatesListDetailPreviewRenderer
          }
        ]
      }
    ]
