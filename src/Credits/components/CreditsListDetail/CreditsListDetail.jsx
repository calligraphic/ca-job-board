...
class CreditsListDetail extends PureComponent {
  render() {
...
CreditsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
CreditsListDetail.displayName = 'CreditsListDetail';

export default CreditsListDetail;
