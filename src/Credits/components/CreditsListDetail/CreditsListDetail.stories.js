...
import CreditsListDetailReadme from './CreditsListDetail.README.md';
...
const WrappedCreditsListDetail = StorybookComponentWrapperHOC(
  CreditsListDetail
);

// React render function
const CreditsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCreditsListDetail />
    </State>
  );
};
...
storiesOf('Credits', module)
  ...
  .addWithChapters('Credits List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CreditsListDetailReadme,
            sectionFn: CreditsListDetailPreviewRenderer
          }
        ]
      }
    ]
