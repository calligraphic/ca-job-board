...
import CreditsListReadme from './CreditsList.README.md';
...
const WrappedCreditsList = StorybookComponentWrapperHOC(CreditsList);

// React render function
const CreditsListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCreditsList />
    </State>
...
storiesOf('Credits', module)
  ...
  .addWithChapters('Credits List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CreditsListReadme,
            sectionFn: CreditsListPreviewRenderer
          }
        ]
      }
    ]
