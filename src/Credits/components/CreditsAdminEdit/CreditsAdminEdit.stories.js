...
import CreditsAdminEditReadme from './CreditsAdminEdit.README.md';
...
const WrappedCreditsAdminEdit = StorybookComponentWrapperHOC(CreditsAdminEdit);

// React render function
const CreditsAdminEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCreditsAdminEdit />
    </State>
  );
};
...
storiesOf('Credits', module)
  ...
  .addWithChapters('Credits Admin Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CreditsAdminEditReadme,
            sectionFn: CreditsAdminEditPreviewRenderer
          }
        ]
      }
    ]
