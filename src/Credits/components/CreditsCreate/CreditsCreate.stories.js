...
// Component import
import CreditsCreate from './CreditsCreate';
import CreditsCreateReadme from './CreditsCreate.README.md';
...
const WrappedCreditsCreate = StorybookComponentWrapperHOC(CreditsCreate);

// React render function
const CreditsCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCreditsCreate />
    </State>
  );
};
...
storiesOf('Credits', module)
  ...
  .addWithChapters('Credits Create (buy) Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CreditsCreateReadme,
            sectionFn: CreditsCreatePreviewRenderer
          }
        ]
      }
    ]
