...
class CreditsAdminCreate extends PureComponent {
  render() {
...
CreditsAdminCreate.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
CreditsAdminCreate.displayName = 'CreditsAdminCreate';

export default CreditsAdminCreate;
