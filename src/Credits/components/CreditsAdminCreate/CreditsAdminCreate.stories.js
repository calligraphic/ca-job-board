...
// Component import
import CreditsAdminCreate from './CreditsAdminCreate';
import CreditsAdminCreateReadme from './CreditsAdminCreate.README.md';
...
const WrappedCreditsAdminCreate = StorybookComponentWrapperHOC(
  CreditsAdminCreate
);

// React render function
const CreditsAdminCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCreditsAdminCreate />
    </State>
  );
};
...
storiesOf('Credits', module)
  ...
  .addWithChapters('Credits Admin Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CreditsAdminCreateReadme,
            sectionFn: CreditsAdminCreatePreviewRenderer
          }
        ]
      }
    ]
