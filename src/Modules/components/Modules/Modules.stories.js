...
import ModulesReadme from './Modules.README.md';
...
const WrappedModules = StorybookComponentWrapperHOC(Modules);

// React render function
const ModulesPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedModules />
    </State>
        ...
        sections: [
          {
            ...
            subtitle: null,
            info: ModulesReadme,
            sectionFn: ModulesPreviewRenderer
          }
        ]
      }
    ]
