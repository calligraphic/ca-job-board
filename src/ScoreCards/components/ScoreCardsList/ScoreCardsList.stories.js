...
import ScoreCardsListReadme from './ScoreCardsList.README.md';
...
const WrappedScoreCardsList = StorybookComponentWrapperHOC(ScoreCardsList);

// React render function
const ScoreCardsListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedScoreCardsList />
    </State>
  );
};
...
storiesOf('Score Cards Tracking', module)
  ...
  .addWithChapters('Score Cards Tracking List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ScoreCardsListReadme,
            sectionFn: ScoreCardsListPreviewRenderer
          }
        ]
      }
    ]
