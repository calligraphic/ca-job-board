...
// Component import
import ScoreCardsEdit from './ScoreCardsEdit';
import ScoreCardsEditReadme from './ScoreCardsEdit.README.md';
...
const WrappedScoreCardsEdit = StorybookComponentWrapperHOC(ScoreCardsEdit);

// React render function
const ScoreCardsEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedScoreCardsEdit />
    </State>
  );
};
...
storiesOf('Score Cards Tracking', module)
  ...
  .addWithChapters('Score Cards Tracking Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ScoreCardsEditReadme,
            sectionFn: ScoreCardsEditPreviewRenderer
          }
        ]
      }
    ]
