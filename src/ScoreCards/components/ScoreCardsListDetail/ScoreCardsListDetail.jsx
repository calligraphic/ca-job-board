...
class ScoreCardsListDetail extends PureComponent {
  render() {
...
ScoreCardsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ScoreCardsListDetail.displayName = 'ScoreCardsListDetail';

export default ScoreCardsListDetail;
