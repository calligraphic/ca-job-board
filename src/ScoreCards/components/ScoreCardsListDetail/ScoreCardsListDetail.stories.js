...
// Component import
import ScoreCardsListDetail from './ScoreCardsListDetail';
import ScoreCardsListDetailReadme from './ScoreCardsListDetail.README.md';
...
const WrappedScoreCardsListDetail = StorybookComponentWrapperHOC(
  ScoreCardsListDetail
);

// React render function
const ScoreCardsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedScoreCardsListDetail />
    </State>
  );
};

storiesOf('Score Cards Tracking', module)
  .addDecorator(withKnobs)
  .addDecorator((story, context) =>
    withNotes(notesPanelContent)(story)(context)
  )
  .addWithChapters('Score Cards Tracking List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ScoreCardsListDetailReadme,
            sectionFn: ScoreCardsListDetailPreviewRenderer
          }
        ]
      }
    ]
