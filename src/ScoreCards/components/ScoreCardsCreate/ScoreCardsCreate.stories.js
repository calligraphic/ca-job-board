...
// Component import
import ScoreCardsCreate from './ScoreCardsCreate';
import ScoreCardsCreateReadme from './ScoreCardsCreate.README.md';
...
const WrappedScoreCardsCreate = StorybookComponentWrapperHOC(ScoreCardsCreate);

// React render function
const ScoreCardsCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedScoreCardsCreate />
    </State>
  );
};
...
storiesOf('Score Cards Tracking', module)
  ...
  .addWithChapters('Score Cards Tracking Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ScoreCardsCreateReadme,
            sectionFn: ScoreCardsCreatePreviewRenderer
          }
        ]
      }
    ]
