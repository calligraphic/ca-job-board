...
// Component import
import ScoreCardsItem from './ScoreCardsItem';
import ScoreCardsItemReadme from './ScoreCardsItem.README.md';
...
const WrappedScoreCardsItem = StorybookComponentWrapperHOC(ScoreCardsItem);

// React render function
const ScoreCardsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedScoreCardsItem />
    </State>
  );
};
...
storiesOf('Score Cards Tracking', module)
  ...
  .addWithChapters('Score Cards Tracking Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ScoreCardsItemReadme,
            sectionFn: ScoreCardsItemPreviewRenderer
          }
        ]
      }
    ]
