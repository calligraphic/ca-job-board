...
// Component import
import EmployerDepartmentsEdit from './EmployerDepartmentsEdit';
import EmployerDepartmentsEditReadme from './EmployerDepartmentsEdit.README.md';
...
const WrappedEmployerDepartmentsEdit = StorybookComponentWrapperHOC(
  EmployerDepartmentsEdit
);

// React render function
const EmployerDepartmentsEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerDepartmentsEdit />
    </State>
  );
};
...
storiesOf('Employer Departments', module)
  ...
  .addWithChapters('Employer Departments Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerDepartmentsEditReadme,
            sectionFn: EmployerDepartmentsEditPreviewRenderer
          }
        ]
      }
    ]
