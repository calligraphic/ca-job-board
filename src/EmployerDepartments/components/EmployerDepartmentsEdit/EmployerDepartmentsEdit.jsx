...
class EmployerDepartmentsEdit extends PureComponent {
  render() {
...
EmployerDepartmentsEdit.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerDepartmentsEdit.displayName = 'EmployerDepartmentsEdit';

export default EmployerDepartmentsEdit;
