...
class EmployerDepartmentsItem extends PureComponent {
  render() {
...
EmployerDepartmentsItem.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerDepartmentsItem.displayName = 'EmployerDepartmentsItem';

export default EmployerDepartmentsItem;
