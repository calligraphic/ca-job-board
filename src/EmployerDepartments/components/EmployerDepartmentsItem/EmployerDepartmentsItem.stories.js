...
// Component import
import EmployerDepartmentsItem from './EmployerDepartmentsItem';
import EmployerDepartmentsItemReadme from './EmployerDepartmentsItem.README.md';
...
const WrappedEmployerDepartmentsItem = StorybookComponentWrapperHOC(
  EmployerDepartmentsItem
);

// React render function
const EmployerDepartmentsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerDepartmentsItem />
    </State>
  );
};
...
storiesOf('Employer Departments', module)
  ...
  .addWithChapters('Employer Departments Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerDepartmentsItemReadme,
            sectionFn: EmployerDepartmentsItemPreviewRenderer
          }
        ]
      }
    ]
