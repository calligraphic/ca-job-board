...
class EmployerDepartmentsList extends PureComponent {
  render() {
...
EmployerDepartmentsList.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerDepartmentsList.displayName = 'EmployerDepartmentsList';

export default EmployerDepartmentsList;
