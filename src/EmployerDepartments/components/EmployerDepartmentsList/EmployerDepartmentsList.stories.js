...
import EmployerDepartmentsListReadme from './EmployerDepartmentsList.README.md';
...
const WrappedEmployerDepartmentsList = StorybookComponentWrapperHOC(
  EmployerDepartmentsList
);

// React render function
const EmployerDepartmentsListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerDepartmentsList />
    </State>
  );
};
...
storiesOf('Employer Departments', module)
  ...
  .addWithChapters('Employer Departments List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerDepartmentsListReadme,
            sectionFn: EmployerDepartmentsListPreviewRenderer
          }
        ]
      }
    ]
