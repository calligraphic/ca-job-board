...
class EmployerDepartmentsCreate extends PureComponent {
  render() {
...
EmployerDepartmentsCreate.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerDepartmentsCreate.displayName = 'EmployerDepartmentsCreate';

export default EmployerDepartmentsCreate;
