...
// Component import
import EmployerDepartmentsCreate from './EmployerDepartmentsCreate';
import EmployerDepartmentsCreateReadme from './EmployerDepartmentsCreate.README.md';
...
const WrappedEmployerDepartmentsCreate = StorybookComponentWrapperHOC(
  EmployerDepartmentsCreate
);

// React render function
const EmployerDepartmentsCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerDepartmentsCreate />
    </State>
  );
};
...
storiesOf('Employer Departments', module)
  ...
  .addWithChapters('Employer Departments Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerDepartmentsCreateReadme,
            sectionFn: EmployerDepartmentsCreatePreviewRenderer
          }
        ]
      }
    ]
