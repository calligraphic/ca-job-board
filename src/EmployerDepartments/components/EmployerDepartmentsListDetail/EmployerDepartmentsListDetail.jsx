...
class EmployerDepartmentsListDetail extends PureComponent {
  render() {
...
EmployerDepartmentsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerDepartmentsListDetail.displayName = 'EmployerDepartmentsListDetail';

export default EmployerDepartmentsListDetail;
