...
// Component import
import EmployerDepartmentsListDetail from './EmployerDepartmentsListDetail';
import EmployerDepartmentsListDetailReadme from './EmployerDepartmentsListDetail.README.md';
...
const WrappedEmployerDepartmentsListDetail = StorybookComponentWrapperHOC(
  EmployerDepartmentsListDetail
);

// React render function
const EmployerDepartmentsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerDepartmentsListDetail />
    </State>
  );
};

storiesOf('Employer Departments', module)
  .addDecorator(withKnobs)
  .addDecorator((story, context) =>
    withNotes(notesPanelContent)(story)(context)
  )
  .addWithChapters('Employer Departments List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerDepartmentsListDetailReadme,
            sectionFn: EmployerDepartmentsListDetailPreviewRenderer
          }
        ]
      }
    ]
