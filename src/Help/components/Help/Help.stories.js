...
import HelpReadme from './Help.README.md';
...
const WrappedHelp = StorybookComponentWrapperHOC(Help);

// React render function
const HelpPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedHelp />
    </State>
