...
import RolesItemReadme from './RolesItem.README.md';
...
const WrappedRolesItem = StorybookComponentWrapperHOC(RolesItem);

// React render function
const RolesItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRolesItem />
    </State>
...
storiesOf('Roles', module)
  ...
  .addWithChapters('Roles Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RolesItemReadme,
            sectionFn: RolesItemPreviewRenderer
          }
        ]
      }
    ]
