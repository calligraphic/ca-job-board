...
import RolesListReadme from './RolesList.README.md';
...
const WrappedRolesList = StorybookComponentWrapperHOC(RolesList);

// React render function
const RolesListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRolesList />
    </State>
...
storiesOf('Roles', module)
  ...
  .addWithChapters('Roles List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RolesListReadme,
            sectionFn: RolesListPreviewRenderer
          }
        ]
      }
    ]
