...
import RolesCreateReadme from './RolesCreate.README.md';
...
const WrappedRolesCreate = StorybookComponentWrapperHOC(RolesCreate);

// React render function
const RolesCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRolesCreate />
    </State>
...
storiesOf('Roles', module)
  ...
  .addWithChapters('Roles Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RolesCreateReadme,
            sectionFn: RolesCreatePreviewRenderer
          }
        ]
      }
    ]
