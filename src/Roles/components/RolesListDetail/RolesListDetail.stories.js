...
// Component import
import RolesListDetail from './RolesListDetail';
import RolesListDetailReadme from './RolesListDetail.README.md';
...
const WrappedRolesListDetail = StorybookComponentWrapperHOC(RolesListDetail);

// React render function
const RolesListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRolesListDetail />
    </State>
  );
};

storiesOf('Roles', module)
  .addDecorator(withKnobs)
  .addDecorator((story, context) =>
    withNotes(notesPanelContent)(story)(context)
  )
  .addWithChapters('Roles List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RolesListDetailReadme,
            sectionFn: RolesListDetailPreviewRenderer
          }
        ]
      }
    ]
