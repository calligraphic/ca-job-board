...
import QuestionnairesListReadme from './QuestionnairesList.README.md';
...
const WrappedQuestionnairesList = StorybookComponentWrapperHOC(
  QuestionnairesList
);

// React render function
const QuestionnairesListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedQuestionnairesList />
    </State>
  );
};
...
storiesOf('Questionnaires', module)
  ...
  .addWithChapters('Questionnaires List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: QuestionnairesListReadme,
            sectionFn: QuestionnairesListPreviewRenderer
          }
        ]
      }
    ]
