...
// Component import
import QuestionnairesItem from './QuestionnairesItem';
import QuestionnairesItemReadme from './QuestionnairesItem.README.md';
...
const WrappedQuestionnairesItem = StorybookComponentWrapperHOC(
  QuestionnairesItem
);

// React render function
const QuestionnairesItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedQuestionnairesItem />
    </State>
  );
};
...
storiesOf('Questionnaires', module)
  ...
  .addWithChapters('Questionnaires Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: QuestionnairesItemReadme,
            sectionFn: QuestionnairesItemPreviewRenderer
          }
        ]
      }
    ]
