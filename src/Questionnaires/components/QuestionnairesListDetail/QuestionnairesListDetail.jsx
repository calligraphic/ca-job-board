...
class QuestionnairesListDetail extends PureComponent {
  render() {
...
QuestionnairesListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
QuestionnairesListDetail.displayName = 'QuestionnairesListDetail';

export default QuestionnairesListDetail;
