...
import QuestionnairesCreateReadme from './QuestionnairesCreate.README.md';
...
const WrappedQuestionnairesCreate = StorybookComponentWrapperHOC(
  QuestionnairesCreate
);

// React render function
const QuestionnairesCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedQuestionnairesCreate />
    </State>
  );
};
...
storiesOf('Questionnaires', module)
  ...
  .addWithChapters('Questionnaires Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: QuestionnairesCreateReadme,
            sectionFn: QuestionnairesCreatePreviewRenderer
          }
        ]
      }
    ]
