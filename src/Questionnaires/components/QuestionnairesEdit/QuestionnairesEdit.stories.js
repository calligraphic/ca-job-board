...
import QuestionnairesEditReadme from './QuestionnairesEdit.README.md';
...
const WrappedQuestionnairesEdit = StorybookComponentWrapperHOC(
  QuestionnairesEdit
);

// React render function
const QuestionnairesEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedQuestionnairesEdit />
    </State>
  );
};
...
storiesOf('Questionnaires', module)
  ...
  .addWithChapters('Questionnaires Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: QuestionnairesEditReadme,
            sectionFn: QuestionnairesEditPreviewRenderer
          }
        ]
      }
    ]
