...
import DefaultFeedRSSReadme from './DefaultFeedRSS.README.md';
...
const WrappedDefaultFeedRSS = StorybookComponentWrapperHOC(DefaultFeedRSS);

// React render function
const DefaultFeedRSSPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedDefaultFeedRSS />
    </State>
  );
};
...
storiesOf('Miscellaneous', module)
  ...
  .addWithChapters('RSS Default Feeds', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: DefaultFeedRSSReadme,
            sectionFn: DefaultFeedRSSPreviewRenderer
          }
        ]
      }
    ]
