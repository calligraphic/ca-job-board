...
// Component import
import ForwardJobToFriend from './ForwardJobToFriend';
import ForwardJobToFriendReadme from './ForwardJobToFriend.README.md';
...
const WrappedForwardJobToFriend = StorybookComponentWrapperHOC(
  ForwardJobToFriend
);

// React render function
const ForwardJobToFriendPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedForwardJobToFriend />
    </State>
  );
};
...
storiesOf('Miscellaneous', module)
  ...
  .addWithChapters('Forward Job To a Friend', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ForwardJobToFriendReadme,
            sectionFn: ForwardJobToFriendPreviewRenderer
          }
        ]
      }
    ]
