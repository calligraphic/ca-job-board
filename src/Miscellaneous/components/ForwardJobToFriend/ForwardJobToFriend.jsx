...
class ForwardJobToFriend extends PureComponent {
  render() {
...
ForwardJobToFriend.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ForwardJobToFriend.displayName = 'ForwardJobToFriend';

export default ForwardJobToFriend;
