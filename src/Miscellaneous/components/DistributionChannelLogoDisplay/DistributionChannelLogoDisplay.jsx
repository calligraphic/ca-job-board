...
class DistributionChannelLogoDisplay extends PureComponent {
  render() {
...
DistributionChannelLogoDisplay.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
DistributionChannelLogoDisplay.displayName = 'DistributionChannelLogoDisplay';

export default DistributionChannelLogoDisplay;
