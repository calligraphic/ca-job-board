...
import SchedulingEditReadme from './SchedulingEdit.README.md';
...
const WrappedSchedulingEdit = StorybookComponentWrapperHOC(SchedulingEdit);

// React render function
const SchedulingEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSchedulingEdit />
    </State>
  );
};
...
storiesOf('Scheduling', module)
  ...
  .addWithChapters('Scheduling Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SchedulingEditReadme,
            sectionFn: SchedulingEditPreviewRenderer
          }
        ]
      }
    ]
