...
import SchedulingItemReadme from './SchedulingItem.README.md';
...
const WrappedSchedulingItem = StorybookComponentWrapperHOC(SchedulingItem);

// React render function
const SchedulingItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSchedulingItem />
    </State>
  );
};
...
storiesOf('Scheduling', module)
  ...
  .addWithChapters('Scheduling Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SchedulingItemReadme,
            sectionFn: SchedulingItemPreviewRenderer
          }
        ]
      }
    ]
