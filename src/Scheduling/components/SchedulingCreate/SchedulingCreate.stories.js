...
import SchedulingCreateReadme from './SchedulingCreate.README.md';
...
const WrappedSchedulingCreate = StorybookComponentWrapperHOC(SchedulingCreate);

// React render function
const SchedulingCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSchedulingCreate />
    </State>
  );
};
...
storiesOf('Scheduling', module)
  ...
  .addWithChapters('Scheduling Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SchedulingCreateReadme,
            sectionFn: SchedulingCreatePreviewRenderer
          }
        ]
      }
    ]
