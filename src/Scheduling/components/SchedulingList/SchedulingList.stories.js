...
import SchedulingListReadme from './SchedulingList.README.md';
...
const WrappedSchedulingList = StorybookComponentWrapperHOC(SchedulingList);

// React render function
const SchedulingListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSchedulingList />
    </State>
  );
};
...
storiesOf('Scheduling', module)
  ...
  .addWithChapters('Scheduling List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SchedulingListReadme,
            sectionFn: SchedulingListPreviewRenderer
          }
        ]
      }
    ]
