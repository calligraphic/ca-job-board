...
class SchedulingListDetail extends PureComponent {
  render() {
...
SchedulingListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
SchedulingListDetail.displayName = 'SchedulingListDetail';

export default SchedulingListDetail;
