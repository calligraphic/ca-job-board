...
// Component import
import SchedulingListDetail from './SchedulingListDetail';
import SchedulingListDetailReadme from './SchedulingListDetail.README.md';
...
const WrappedSchedulingListDetail = StorybookComponentWrapperHOC(
  SchedulingListDetail
);

// React render function
const SchedulingListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSchedulingListDetail />
    </State>
  );
};
...
storiesOf('Scheduling', module)
  ...
  .addWithChapters('Scheduling List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SchedulingListDetailReadme,
            sectionFn: SchedulingListDetailPreviewRenderer
          }
        ]
      }
    ]
