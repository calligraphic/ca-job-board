...
import FieldsCreateReadme from './FieldsCreate.README.md';
...
const WrappedFieldsCreate = StorybookComponentWrapperHOC(FieldsCreate);

// React render function
const FieldsCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedFieldsCreate />
    </State>
...
storiesOf('Fields', module)
  ...
  .addWithChapters('Fieldss Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: FieldsCreateReadme,
            sectionFn: FieldsCreatePreviewRenderer
          }
        ]
      }
    ]
