...
import FieldsListReadme from './FieldsList.README.md';
...
const WrappedFieldsList = StorybookComponentWrapperHOC(FieldsList);

// React render function
const FieldsListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedFieldsList />
    </State>
...
storiesOf('Fields', module)
  ...
  .addWithChapters('Fields List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: FieldsListReadme,
            sectionFn: FieldsListPreviewRenderer
          }
        ]
      }
    ]
