...
import FieldsEditReadme from './FieldsEdit.README.md';
...
const WrappedFieldsEdit = StorybookComponentWrapperHOC(FieldsEdit);

// React render function
const FieldsEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedFieldsEdit />
    </State>
...
storiesOf('Fields', module)
  ...
  .addWithChapters('Fields Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: FieldsEditReadme,
            sectionFn: FieldsEditPreviewRenderer
          }
        ]
      }
    ]
