...
// Component import
import FieldsListDetail from './FieldsListDetail';
import FieldsListDetailReadme from './FieldsListDetail.README.md';
...
const WrappedFieldsListDetail = StorybookComponentWrapperHOC(FieldsListDetail);

// React render function
const FieldsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedFieldsListDetail />
    </State>
  );
};
...
storiesOf('Fields', module)
  ...
  .addWithChapters('Fields List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: FieldsListDetailReadme,
            sectionFn: FieldsListDetailPreviewRenderer
          }
        ]
      }
    ]
