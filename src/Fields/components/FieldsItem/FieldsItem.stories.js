...
import FieldsItemReadme from './FieldsItem.README.md';
...
const WrappedFieldsItem = StorybookComponentWrapperHOC(FieldsItem);

// React render function
const FieldsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedFieldsItem />
    </State>
...
storiesOf('Fields', module)
  ...
  .addWithChapters('Fields Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: FieldsItemReadme,
            sectionFn: FieldsItemPreviewRenderer
          }
        ]
      }
    ]
