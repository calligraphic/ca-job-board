...
import JobPostingEditReadme from './JobPostingEdit.README.md';
...
const WrappedJobPostingEdit = StorybookComponentWrapperHOC(JobPostingEdit);

// React render function
const JobPostingEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobPostingEdit />
    </State>
  );
};
...
storiesOf('Job Postings', module)
  ...
  .addWithChapters('Job Posting Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobPostingEditReadme,
            sectionFn: JobPostingEditPreviewRenderer
          }
        ]
      }
    ]
