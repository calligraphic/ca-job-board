...
// Component import
import JobPostingListDetail from './JobPostingListDetail';
import JobPostingListDetailReadme from './JobPostingListDetail.README.md';
...
const WrappedJobPostingListDetail = StorybookComponentWrapperHOC(
  JobPostingListDetail
);

// React render function
const JobPostingListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobPostingListDetail />
    </State>
  );
};
...
storiesOf('Job Postings', module)
  ...
  .addWithChapters('Job Posting List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobPostingListDetailReadme,
            sectionFn: JobPostingListDetailPreviewRenderer
          }
        ]
      }
    ]
