...
import ReferencesEditReadme from './ReferencesEdit.README.md';
...
const WrappedReferencesEdit = StorybookComponentWrapperHOC(ReferencesEdit);

// React render function
const ReferencesEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedReferencesEdit />
    </State>
  );
};
...
storiesOf('References', module)
  ...
  .addWithChapters('References Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ReferencesEditReadme,
            sectionFn: ReferencesEditPreviewRenderer
          }
        ]
      }
    ]
