...
import ReferencesItemReadme from './ReferencesItem.README.md';
...
const WrappedReferencesItem = StorybookComponentWrapperHOC(ReferencesItem);

// React render function
const ReferencesItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedReferencesItem />
    </State>
  );
};
...
storiesOf('References', module)
  ...
  .addWithChapters('References Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ReferencesItemReadme,
            sectionFn: ReferencesItemPreviewRenderer
          }
        ]
      }
    ]
