...
// Component import
import ReferencesCreate from './ReferencesCreate';
import ReferencesCreateReadme from './ReferencesCreate.README.md';
...
const WrappedReferencesCreate = StorybookComponentWrapperHOC(ReferencesCreate);

// React render function
const ReferencesCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedReferencesCreate />
    </State>
  );
};
...
storiesOf('References', module)
  ...
  .addWithChapters('References Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ReferencesCreateReadme,
            sectionFn: ReferencesCreatePreviewRenderer
          }
        ]
      }
    ]
