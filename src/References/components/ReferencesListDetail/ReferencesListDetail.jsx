...
class ReferencesListDetail extends PureComponent {
  render() {
...
ReferencesListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ReferencesListDetail.displayName = 'ReferencesListDetail';

export default ReferencesListDetail;
