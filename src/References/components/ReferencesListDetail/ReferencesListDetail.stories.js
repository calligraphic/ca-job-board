...
// Component import
import ReferencesListDetail from './ReferencesListDetail';
import ReferencesListDetailReadme from './ReferencesListDetail.README.md';
...
const WrappedReferencesListDetail = StorybookComponentWrapperHOC(
  ReferencesListDetail
);

// React render function
const ReferencesListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedReferencesListDetail />
    </State>
  );
};
...
storiesOf('References', module)
  ...
  .addWithChapters('References List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ReferencesListDetailReadme,
            sectionFn: ReferencesListDetailPreviewRenderer
          }
        ]
      }
    ]
