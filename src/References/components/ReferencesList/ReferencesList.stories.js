...
import ReferencesListReadme from './ReferencesList.README.md';
...
const WrappedReferencesList = StorybookComponentWrapperHOC(ReferencesList);

// React render function
const ReferencesListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedReferencesList />
    </State>
  );
};
...
storiesOf('References', module)
  ...
  .addWithChapters('References List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ReferencesListReadme,
            sectionFn: ReferencesListPreviewRenderer
          }
        ]
      }
    ]
