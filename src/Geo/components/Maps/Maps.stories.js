...
import MapsReadme from './Maps.README.md';
...
const WrappedMaps = StorybookComponentWrapperHOC(Maps);

// React render function
const MapsPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedMaps />
    </State>
