...
// Component import
import PPC from './PPC';
import PPCReadme from './PPC.README.md';
...
const WrappedPPC = StorybookComponentWrapperHOC(PPC);

// React render function
const PPCPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedPPC />
    </State>
