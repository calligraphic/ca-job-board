...
class RecruitersRegister extends PureComponent {
  render() {
...
RecruitersRegister.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
RecruitersRegister.displayName = 'RecruitersRegister';

export default RecruitersRegister;
