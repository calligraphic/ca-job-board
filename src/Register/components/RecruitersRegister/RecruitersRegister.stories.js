...
// Component import
import RecruitersRegister from './RecruitersRegister';
import RecruitersRegisterReadme from './RecruitersRegister.README.md';
...
const WrappedRecruitersRegister = StorybookComponentWrapperHOC(
  RecruitersRegister
);

// React render function
const RecruitersRegisterPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRecruitersRegister />
    </State>
  );
};
...
storiesOf('Register', module)
  ...
  .addWithChapters('Recruiters Register Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RecruitersRegisterReadme,
            sectionFn: RecruitersRegisterPreviewRenderer
          }
        ]
      }
    ]
