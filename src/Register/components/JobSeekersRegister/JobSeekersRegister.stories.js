...
// Component import
import JobSeekersRegister from './JobSeekersRegister';
import JobSeekersRegisterReadme from './JobSeekersRegister.README.md';
...
const WrappedJobSeekersRegister = StorybookComponentWrapperHOC(
  JobSeekersRegister
);

// React render function
const JobSeekersRegisterPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobSeekersRegister />
    </State>
  );
};
...
storiesOf('Register', module)
  ...
  .addWithChapters('Job Seekers Register', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobSeekersRegisterReadme,
            sectionFn: JobSeekersRegisterPreviewRenderer
          }
        ]
      }
    ]
