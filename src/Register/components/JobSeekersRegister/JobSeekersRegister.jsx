...
class JobSeekersRegister extends PureComponent {
  render() {
...
JobSeekersRegister.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobSeekersRegister.displayName = 'JobSeekersRegister';

export default JobSeekersRegister;
