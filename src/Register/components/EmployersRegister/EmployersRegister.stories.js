...
import EmployersRegisterReadme from './EmployersRegister.README.md';
...
const WrappedEmployersRegister = StorybookComponentWrapperHOC(
  EmployersRegister
);

// React render function
const EmployersRegisterPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployersRegister />
    </State>
  );
};
...
storiesOf('Register', module)
  ...
  .addWithChapters('Employers Register Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployersRegisterReadme,
            sectionFn: EmployersRegisterPreviewRenderer
          }
        ]
      }
    ]
