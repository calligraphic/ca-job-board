...
import DashboardReadme from './Dashboard.README.md';
...
const WrappedDashboard = StorybookComponentWrapperHOC(Dashboard);

// React render function
const DashboardPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedDashboard />
    </State>
...
storiesOf('Job Seeker Panel', module)
  ...
  .addWithChapters('Job Seeker Dashboard Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: DashboardReadme,
            sectionFn: DashboardPreviewRenderer
          }
        ]
      }
    ]
