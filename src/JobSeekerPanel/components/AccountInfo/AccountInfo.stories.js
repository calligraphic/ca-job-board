...
import AccountInfoReadme from './AccountInfo.README.md';
...
const WrappedAccountInfo = StorybookComponentWrapperHOC(AccountInfo);

// React render function
const AccountInfoPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAccountInfo />
    </State>
...
storiesOf('Job Seeker Panel', module)
  .addDecorator(withKnobs)
  .addDecorator((story, context) =>
    withNotes(notesPanelContent)(story)(context)
  )
  .addWithChapters('Job Seeker Account Info Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AccountInfoReadme,
            sectionFn: AccountInfoPreviewRenderer
          }
        ]
      }
    ]
