...
// Component import
import ApplicationsListDetail from './ApplicationsListDetail';
import ApplicationsListDetailReadme from './ApplicationsListDetail.README.md';
...
const WrappedApplicationsListDetail = StorybookComponentWrapperHOC(
  ApplicationsListDetail
);

// React render function
const ApplicationsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedApplicationsListDetail />
    </State>
  );
};
...
storiesOf('Applications', module)
  ...
  .addWithChapters('Application List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ApplicationsListDetailReadme,
            sectionFn: ApplicationsListDetailPreviewRenderer
          }
        ]
      }
    ]
