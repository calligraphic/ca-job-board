...
class ApplicationsListDetail extends PureComponent {
  render() {
...
ApplicationsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ApplicationsListDetail.displayName = 'ApplicationsListDetail';

export default ApplicationsListDetail;
