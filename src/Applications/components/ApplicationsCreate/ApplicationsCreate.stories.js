...
import ApplicationsCreateReadme from './ApplicationsCreate.README.md';
...
const WrappedApplicationsCreate = StorybookComponentWrapperHOC(
  ApplicationsCreate
);

// React render function
const ApplicationsCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedApplicationsCreate />
    </State>
  );
};
...
storiesOf('Applications', module)
  ...
  .addWithChapters('Applications Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ApplicationsCreateReadme,
            sectionFn: ApplicationsCreatePreviewRenderer
          }
        ]
      }
    ]
