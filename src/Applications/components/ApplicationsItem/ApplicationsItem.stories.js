...
import ApplicationsItemReadme from './ApplicationsItem.README.md';
...
const WrappedApplicationsItem = StorybookComponentWrapperHOC(ApplicationsItem);

// React render function
const ApplicationsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedApplicationsItem />
    </State>
  );
};
...
storiesOf('Applications', module)
  ...
  .addWithChapters('Applications Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ApplicationsItemReadme,
            sectionFn: ApplicationsItemPreviewRenderer
          }
        ]
      }
    ]
