...
import ApplicationsListReadme from './ApplicationsList.README.md';
...
const WrappedApplicationsList = StorybookComponentWrapperHOC(ApplicationsList);

// React render function
const ApplicationsListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedApplicationsList />
    </State>
  );
};
...
storiesOf('Applications', module)
  ...
  .addWithChapters('Applications List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ApplicationsListReadme,
            sectionFn: ApplicationsListPreviewRenderer
          }
        ]
      }
    ]
