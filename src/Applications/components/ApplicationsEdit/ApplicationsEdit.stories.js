...
import ApplicationsEditReadme from './ApplicationsEdit.README.md';
...
const WrappedApplicationsEdit = StorybookComponentWrapperHOC(ApplicationsEdit);

// React render function
const ApplicationsEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedApplicationsEdit />
    </State>
  );
};
...
storiesOf('Applications', module)
  ...
  .addWithChapters('Applications Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ApplicationsEditReadme,
            sectionFn: ApplicationsEditPreviewRenderer
          }
        ]
      }
    ]
