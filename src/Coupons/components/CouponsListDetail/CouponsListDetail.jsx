...
class CouponsListDetail extends PureComponent {
  render() {
...
CouponsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
CouponsListDetail.displayName = 'CouponsListDetail';

export default CouponsListDetail;
