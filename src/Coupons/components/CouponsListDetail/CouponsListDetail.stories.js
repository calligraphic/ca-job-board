...
// Component import
import CouponsListDetail from './CouponsListDetail';
import CouponsListDetailReadme from './CouponsListDetail.README.md';
...
const WrappedCouponsListDetail = StorybookComponentWrapperHOC(
  CouponsListDetail
);

// React render function
const CouponsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCouponsListDetail />
    </State>
  );
};
...
storiesOf('Coupons', module)
  ...
  .addWithChapters('Coupons List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CouponsListDetailReadme,
            sectionFn: CouponsListDetailPreviewRenderer
          }
        ]
      }
    ]
