...
import CouponsListReadme from './CouponsList.README.md';
...
const WrappedCouponsList = StorybookComponentWrapperHOC(CouponsList);

// React render function
const CouponsListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCouponsList />
    </State>
...
storiesOf('Coupons', module)
  ...
  .addWithChapters('Coupons List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CouponsListReadme,
            sectionFn: CouponsListPreviewRenderer
          }
        ]
      }
    ]
