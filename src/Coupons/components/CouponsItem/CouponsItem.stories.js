...
import CouponsItemReadme from './CouponsItem.README.md';
...
const WrappedCouponsItem = StorybookComponentWrapperHOC(CouponsItem);

// React render function
const CouponsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCouponsItem />
    </State>
...
storiesOf('Coupons', module)
  ...
  .addWithChapters('Coupons Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CouponsItemReadme,
            sectionFn: CouponsItemPreviewRenderer
          }
        ]
      }
    ]
