...
import CouponsEditReadme from './CouponsEdit.README.md';
...
const WrappedCouponsEdit = StorybookComponentWrapperHOC(CouponsEdit);

// React render function
const CouponsEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedCouponsEdit />
    </State>
...
storiesOf('Coupons', module)
  ...
  .addWithChapters('Coupons Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: CouponsEditReadme,
            sectionFn: CouponsEditPreviewRenderer
          }
        ]
      }
    ]
