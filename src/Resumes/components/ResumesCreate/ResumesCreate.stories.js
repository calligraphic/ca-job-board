...
import ResumesCreateReadme from './ResumesCreate.README.md';
...
const WrappedResumesCreate = StorybookComponentWrapperHOC(ResumesCreate);

// React render function
const ResumesCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedResumesCreate />
    </State>
  );
};
...
storiesOf('Resumes', module)
  ...
  .addWithChapters('Resumes Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ResumesCreateReadme,
            sectionFn: ResumesCreatePreviewRenderer
          }
        ]
      }
    ]
