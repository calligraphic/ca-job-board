...
import ResumesItemReadme from './ResumesItem.README.md';
...
const WrappedResumesItem = StorybookComponentWrapperHOC(ResumesItem);

// React render function
const ResumesItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedResumesItem />
    </State>
...
storiesOf('Resumes', module)
  ...
  .addWithChapters('Resumes Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ResumesItemReadme,
            sectionFn: ResumesItemPreviewRenderer
          }
        ]
      }
    ]
