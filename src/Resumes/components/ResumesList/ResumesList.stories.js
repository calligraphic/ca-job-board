...
import ResumesListReadme from './ResumesList.README.md';
...
const WrappedResumesList = StorybookComponentWrapperHOC(ResumesList);

// React render function
const ResumesListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedResumesList />
    </State>
...
storiesOf('Resumes', module)
  ...
  .addWithChapters('Resumes List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ResumesListReadme,
            sectionFn: ResumesListPreviewRenderer
          }
        ]
      }
    ]
