...
class ResumesListDetail extends PureComponent {
  render() {
...
ResumesListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ResumesListDetail.displayName = 'ResumesListDetail';

export default ResumesListDetail;
