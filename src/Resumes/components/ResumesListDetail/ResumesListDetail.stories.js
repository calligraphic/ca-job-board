...
// Component import
import ResumesListDetail from './ResumesListDetail';
import ResumesListDetailReadme from './ResumesListDetail.README.md';
...
const WrappedResumesListDetail = StorybookComponentWrapperHOC(
  ResumesListDetail
);

// React render function
const ResumesListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedResumesListDetail />
    </State>
  );
};

storiesOf('Resumes', module)
  .addDecorator(withKnobs)
  .addDecorator((story, context) =>
    withNotes(notesPanelContent)(story)(context)
  )
  .addWithChapters('Resumes List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ResumesListDetailReadme,
            sectionFn: ResumesListDetailPreviewRenderer
          }
        ]
      }
    ]
