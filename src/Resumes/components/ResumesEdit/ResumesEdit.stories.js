...
// Component import
import ResumesEdit from './ResumesEdit';
import ResumesEditReadme from './ResumesEdit.README.md';
...
const WrappedResumesEdit = StorybookComponentWrapperHOC(ResumesEdit);

// React render function
const ResumesEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedResumesEdit />
    </State>
...
storiesOf('Resumes', module)
  ...
  .addWithChapters('Resumes Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ResumesEditReadme,
            sectionFn: ResumesEditPreviewRenderer
          }
        ]
      }
    ]
