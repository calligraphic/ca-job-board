...
class EmployerReviewsEdit extends PureComponent {
  render() {
...
EmployerReviewsEdit.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerReviewsEdit.displayName = 'EmployerReviewsEdit';

export default EmployerReviewsEdit;
