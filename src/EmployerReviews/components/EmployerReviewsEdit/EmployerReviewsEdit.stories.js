...
// Component import
import EmployerReviewsEdit from './EmployerReviewsEdit';
import EmployerReviewsEditReadme from './EmployerReviewsEdit.README.md';
...
const WrappedEmployerReviewsEdit = StorybookComponentWrapperHOC(
  EmployerReviewsEdit
);

// React render function
const EmployerReviewsEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerReviewsEdit />
    </State>
  );
};
...
storiesOf('Employer Reviews', module)
  ...
  .addWithChapters('Reviews Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerReviewsEditReadme,
            sectionFn: EmployerReviewsEditPreviewRenderer
          }
        ]
      }
    ]
