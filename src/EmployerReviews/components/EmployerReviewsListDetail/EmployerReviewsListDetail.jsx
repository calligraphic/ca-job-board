...
class EmployerReviewsListDetail extends PureComponent {
  render() {
...
EmployerReviewsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerReviewsListDetail.displayName = 'EmployerReviewsListDetail';

export default EmployerReviewsListDetail;
