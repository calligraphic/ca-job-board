...
// Component import
import EmployerReviewsAdminConfig from './EmployerReviewsAdminConfig';
import EmployerReviewsAdminConfigReadme from './EmployerReviewsAdminConfig.README.md';
...
const WrappedEmployerReviewsAdminConfig = StorybookComponentWrapperHOC(
  EmployerReviewsAdminConfig
);

// React render function
const EmployerReviewsAdminConfigPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerReviewsAdminConfig />
    </State>
  );
};
...
storiesOf('Employer Reviews', module)
  ...
  .addWithChapters('Reviews Admin Config Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerReviewsAdminConfigReadme,
            sectionFn: EmployerReviewsAdminConfigPreviewRenderer
          }
        ]
      }
    ]
