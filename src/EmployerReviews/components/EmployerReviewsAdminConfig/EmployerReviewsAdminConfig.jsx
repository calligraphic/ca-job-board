...
class EmployerReviewsAdminConfig extends PureComponent {
  render() {
...
EmployerReviewsAdminConfig.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerReviewsAdminConfig.displayName = 'EmployerReviewsAdminConfig';

export default EmployerReviewsAdminConfig;
