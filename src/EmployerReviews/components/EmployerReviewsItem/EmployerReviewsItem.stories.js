...
// Component import
import EmployerReviewsItem from './EmployerReviewsItem';
import EmployerReviewsItemReadme from './EmployerReviewsItem.README.md';
...
const WrappedEmployerReviewsItem = StorybookComponentWrapperHOC(
  EmployerReviewsItem
);

// React render function
const EmployerReviewsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerReviewsItem />
    </State>
  );
};
...
storiesOf('Employer Reviews', module)
  ...
  .addWithChapters('Reviews Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerReviewsItemReadme,
            sectionFn: EmployerReviewsItemPreviewRenderer
          }
        ]
      }
    ]
