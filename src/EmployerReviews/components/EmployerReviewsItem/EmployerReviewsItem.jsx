...
class EmployerReviewsItem extends PureComponent {
  render() {
...
EmployerReviewsItem.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerReviewsItem.displayName = 'EmployerReviewsItem';

export default EmployerReviewsItem;
