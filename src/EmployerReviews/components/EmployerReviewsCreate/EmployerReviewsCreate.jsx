...
class EmployerReviewsCreate extends PureComponent {
  render() {
...
EmployerReviewsCreate.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerReviewsCreate.displayName = 'EmployerReviewsCreate';

export default EmployerReviewsCreate;
