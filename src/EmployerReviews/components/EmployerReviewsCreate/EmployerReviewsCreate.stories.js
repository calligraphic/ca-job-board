...
// Component import
import EmployerReviewsCreate from './EmployerReviewsCreate';
import EmployerReviewsCreateReadme from './EmployerReviewsCreate.README.md';
...
const WrappedEmployerReviewsCreate = StorybookComponentWrapperHOC(
  EmployerReviewsCreate
);

// React render function
const EmployerReviewsCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerReviewsCreate />
    </State>
  );
};
...
storiesOf('Employer Reviews', module)
  ...
  .addWithChapters('Reviews Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerReviewsCreateReadme,
            sectionFn: EmployerReviewsCreatePreviewRenderer
          }
        ]
      }
    ]
