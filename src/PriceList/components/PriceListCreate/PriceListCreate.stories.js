...
import PriceListCreateReadme from './PriceListCreate.README.md';
...
const WrappedPriceListCreate = StorybookComponentWrapperHOC(PriceListCreate);

// React render function
const PriceListCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedPriceListCreate />
    </State>
  );
};
...
storiesOf('Price List', module)
  ...
  .addWithChapters('Price List Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: PriceListCreateReadme,
            sectionFn: PriceListCreatePreviewRenderer
          }
        ]
      }
    ]
