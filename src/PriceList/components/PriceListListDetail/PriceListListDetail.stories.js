...
// Component import
import PriceListListDetail from './PriceListListDetail';
import PriceListListDetailReadme from './PriceListListDetail.README.md';
...
const WrappedPriceListListDetail = StorybookComponentWrapperHOC(
  PriceListListDetail
);

// React render function
const PriceListListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedPriceListListDetail />
    </State>
  );
};
...
storiesOf('Price List', module)
  ...
  .addWithChapters('Price List - List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: PriceListListDetailReadme,
            sectionFn: PriceListListDetailPreviewRenderer
          }
        ]
      }
    ]
