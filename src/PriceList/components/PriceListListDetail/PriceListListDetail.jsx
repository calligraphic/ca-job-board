...
class PriceListListDetail extends PureComponent {
  render() {
...
PriceListListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
PriceListListDetail.displayName = 'PriceListListDetail';

export default PriceListListDetail;
