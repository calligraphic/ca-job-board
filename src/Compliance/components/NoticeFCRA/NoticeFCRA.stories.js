...
// Component import
import NoticeFCRA from './NoticeFCRA';
import NoticeFCRAReadme from './NoticeFCRA.README.md';
...
const WrappedNoticeFCRA = StorybookComponentWrapperHOC(NoticeFCRA);

// React render function
const NoticeFCRAPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedNoticeFCRA />
    </State>
...
storiesOf('Compliance', module)
  .addDecorator(withKnobs)
  .addDecorator((story, context) =>
    withNotes(notesPanelContent)(story)(context)
  )
  .addWithChapters('Notice FCRA Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: NoticeFCRAReadme,
            sectionFn: NoticeFCRAPreviewRenderer
          }
        ]
      }
    ]
