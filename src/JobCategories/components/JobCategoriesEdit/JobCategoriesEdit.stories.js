...
// Component import
import JobCategoriesEdit from './JobCategoriesEdit';
import JobCategoriesEditReadme from './JobCategoriesEdit.README.md';
...
const WrappedJobCategoriesEdit = StorybookComponentWrapperHOC(
  JobCategoriesEdit
);

// React render function
const JobCategoriesEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobCategoriesEdit />
    </State>
  );
};
...
storiesOf('Job Categories', module)
  ...
  .addWithChapters('Job Categories Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobCategoriesEditReadme,
            sectionFn: JobCategoriesEditPreviewRenderer
          }
        ]
      }
    ]
