...
class JobCategoriesEdit extends PureComponent {
  render() {
...
JobCategoriesEdit.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobCategoriesEdit.displayName = 'JobCategoriesEdit';

export default JobCategoriesEdit;
