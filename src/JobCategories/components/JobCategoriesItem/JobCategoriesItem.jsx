...
class JobCategoriesItem extends PureComponent {
  render() {
...
JobCategoriesItem.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobCategoriesItem.displayName = 'JobCategoriesItem';

export default JobCategoriesItem;
