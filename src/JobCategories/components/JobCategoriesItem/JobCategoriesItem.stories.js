...
// Component import
import JobCategoriesItem from './JobCategoriesItem';
import JobCategoriesItemReadme from './JobCategoriesItem.README.md';
...
const WrappedJobCategoriesItem = StorybookComponentWrapperHOC(
  JobCategoriesItem
);

// React render function
const JobCategoriesItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobCategoriesItem />
    </State>
  );
};
...
storiesOf('Job Categories', module)
  ...
  .addWithChapters('Job Categories Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobCategoriesItemReadme,
            sectionFn: JobCategoriesItemPreviewRenderer
          }
        ]
      }
    ]
