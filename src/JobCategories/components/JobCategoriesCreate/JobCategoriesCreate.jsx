...
class JobCategoriesCreate extends PureComponent {
  render() {
...
JobCategoriesCreate.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobCategoriesCreate.displayName = 'JobCategoriesCreate';

export default JobCategoriesCreate;
