...
// Component import
import JobCategoriesCreate from './JobCategoriesCreate';
import JobCategoriesCreateReadme from './JobCategoriesCreate.README.md';
...
const WrappedJobCategoriesCreate = StorybookComponentWrapperHOC(
  JobCategoriesCreate
);

// React render function
const JobCategoriesCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobCategoriesCreate />
    </State>
  );
};
...
storiesOf('Job Categories', module)
  ...
  .addWithChapters('Job Categories Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobCategoriesCreateReadme,
            sectionFn: JobCategoriesCreatePreviewRenderer
          }
        ]
      }
    ]
