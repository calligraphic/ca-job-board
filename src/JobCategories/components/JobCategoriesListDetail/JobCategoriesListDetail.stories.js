...
// Component import
import JobCategoriesListDetail from './JobCategoriesListDetail';
import JobCategoriesListDetailReadme from './JobCategoriesListDetail.README.md';
...
const WrappedJobCategoriesListDetail = StorybookComponentWrapperHOC(
  JobCategoriesListDetail
);

// React render function
const JobCategoriesListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobCategoriesListDetail />
    </State>
  );
};

storiesOf('Job Categories', module)
  .addDecorator(withKnobs)
  .addDecorator((story, context) =>
    withNotes(notesPanelContent)(story)(context)
  )
  .addWithChapters('Job Categories List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobCategoriesListDetailReadme,
            sectionFn: JobCategoriesListDetailPreviewRenderer
          }
        ]
      }
    ]
