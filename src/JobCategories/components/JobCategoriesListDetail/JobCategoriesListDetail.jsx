...
class JobCategoriesListDetail extends PureComponent {
  render() {
...
JobCategoriesListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobCategoriesListDetail.displayName = 'JobCategoriesListDetail';

export default JobCategoriesListDetail;
