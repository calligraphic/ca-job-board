...
// Component import
import JobCategoriesList from './JobCategoriesList';
import JobCategoriesListReadme from './JobCategoriesList.README.md';
...
const WrappedJobCategoriesList = StorybookComponentWrapperHOC(
  JobCategoriesList
);

// React render function
const JobCategoriesListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobCategoriesList />
    </State>
  );
};
...
storiesOf('Job Categories', module)
  ...
  .addWithChapters('Job Categories List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobCategoriesListReadme,
            sectionFn: JobCategoriesListPreviewRenderer
          }
        ]
      }
    ]
