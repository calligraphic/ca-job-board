...
// Component import
import TransactionsAdminCreate from './TransactionsAdminCreate';
import TransactionsAdminCreateReadme from './TransactionsAdminCreate.README.md';
...
const WrappedTransactionsAdminCreate = StorybookComponentWrapperHOC(
  TransactionsAdminCreate
);

// React render function
const TransactionsAdminCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedTransactionsAdminCreate />
    </State>
  );
};
...
storiesOf('Transactions', module)
  ...
  .addWithChapters('Transactions Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: TransactionsAdminCreateReadme,
            sectionFn: TransactionsAdminCreatePreviewRenderer
          }
        ]
      }
    ]
