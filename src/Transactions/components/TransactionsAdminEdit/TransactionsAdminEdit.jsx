...
class TransactionsAdminEdit extends PureComponent {
  render() {
...
TransactionsAdminEdit.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
TransactionsAdminEdit.displayName = 'TransactionsAdminEdit';

export default TransactionsAdminEdit;
