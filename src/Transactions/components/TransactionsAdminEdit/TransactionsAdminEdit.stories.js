...
// Component import
import TransactionsAdminEdit from './TransactionsAdminEdit';
import TransactionsAdminEditReadme from './TransactionsAdminEdit.README.md';
...
const WrappedTransactionsAdminEdit = StorybookComponentWrapperHOC(
  TransactionsAdminEdit
);

// React render function
const TransactionsAdminEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedTransactionsAdminEdit />
    </State>
  );
};
...
storiesOf('Transactions', module)
  ...
  .addWithChapters('Transactions Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: TransactionsAdminEditReadme,
            sectionFn: TransactionsAdminEditPreviewRenderer
          }
        ]
      }
    ]
