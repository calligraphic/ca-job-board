...
import TransactionsItemReadme from './TransactionsItem.README.md';
...
const WrappedTransactionsItem = StorybookComponentWrapperHOC(TransactionsItem);

// React render function
const TransactionsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedTransactionsItem />
    </State>
  );
};
...
storiesOf('Transactions', module)
  ...
  .addWithChapters('Transactions Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: TransactionsItemReadme,
            sectionFn: TransactionsItemPreviewRenderer
          }
        ]
      }
    ]
