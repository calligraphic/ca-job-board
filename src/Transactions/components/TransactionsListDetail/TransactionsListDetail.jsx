...
class TransactionsListDetail extends PureComponent {
  render() {
...
TransactionsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
TransactionsListDetail.displayName = 'TransactionsListDetail';

export default TransactionsListDetail;
