...
// Component import
import TransactionsListDetail from './TransactionsListDetail';
import TransactionsListDetailReadme from './TransactionsListDetail.README.md';
...
const WrappedTransactionsListDetail = StorybookComponentWrapperHOC(
  TransactionsListDetail
);

// React render function
const TransactionsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedTransactionsListDetail />
    </State>
  );
};
...
storiesOf('Transactions', module)
  ...
  .addWithChapters('Transactions List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: TransactionsListDetailReadme,
            sectionFn: TransactionsListDetailPreviewRenderer
          }
        ]
      }
    ]
