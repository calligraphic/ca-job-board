...
import RecommendationsListReadme from './RecommendationsList.README.md';
...
const WrappedRecommendationsList = StorybookComponentWrapperHOC(
  RecommendationsList
);

// React render function
const RecommendationsListPreviewRenderer = () => {
  return (
    <State store={store}>
...
storiesOf('Recommendations', module)
  ...
  .addWithChapters('Recommendations List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RecommendationsListReadme,
            sectionFn: RecommendationsListPreviewRenderer
          }
        ]
      }
    ]
