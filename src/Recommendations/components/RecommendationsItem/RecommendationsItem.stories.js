...
import RecommendationsItemReadme from './RecommendationsItem.README.md';
...
const WrappedRecommendationsItem = StorybookComponentWrapperHOC(
  RecommendationsItem
);

// React render function
const RecommendationsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRecommendationsItem />
    </State>
  );
};
...
storiesOf('Recommendations', module)
  ...
  .addWithChapters('Recommendations Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RecommendationsItemReadme,
            sectionFn: RecommendationsItemPreviewRenderer
          }
        ]
      }
    ]
