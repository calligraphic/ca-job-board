...
// Component import
import RecommendationsListDetail from './RecommendationsListDetail';
import RecommendationsListDetailReadme from './RecommendationsListDetail.README.md';
...
const WrappedRecommendationsListDetail = StorybookComponentWrapperHOC(
  RecommendationsListDetail
);

// React render function
const RecommendationsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRecommendationsListDetail />
    </State>
  );
};
...
storiesOf('Recommendations', module)
  ...
  .addWithChapters('Recommendations List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RecommendationsListDetailReadme,
            sectionFn: RecommendationsListDetailPreviewRenderer
          }
        ]
      }
    ]
