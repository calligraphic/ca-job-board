...
class RecommendationsListDetail extends PureComponent {
  render() {
...
RecommendationsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
RecommendationsListDetail.displayName = 'RecommendationsListDetail';

export default RecommendationsListDetail;
