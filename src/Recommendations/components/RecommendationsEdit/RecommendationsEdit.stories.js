...
import RecommendationsEditReadme from './RecommendationsEdit.README.md';
...
const WrappedRecommendationsEdit = StorybookComponentWrapperHOC(
  RecommendationsEdit
);

// React render function
const RecommendationsEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRecommendationsEdit />
    </State>
  );
};
...
storiesOf('Recommendations', module)
  ...
  .addWithChapters('Recommendations Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RecommendationsEditReadme,
            sectionFn: RecommendationsEditPreviewRenderer
          }
        ]
      }
    ]
