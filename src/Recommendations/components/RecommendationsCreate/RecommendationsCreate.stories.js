...
// Component import
import RecommendationsCreate from './RecommendationsCreate';
import RecommendationsCreateReadme from './RecommendationsCreate.README.md';
...
const WrappedRecommendationsCreate = StorybookComponentWrapperHOC(
  RecommendationsCreate
);

// React render function
const RecommendationsCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRecommendationsCreate />
    </State>
  );
};
...
storiesOf('Recommendations', module)
  ...
  .addWithChapters('Recommendations Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RecommendationsCreateReadme,
            sectionFn: RecommendationsCreatePreviewRenderer
          }
        ]
      }
    ]
