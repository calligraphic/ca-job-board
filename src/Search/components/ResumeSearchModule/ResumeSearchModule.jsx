...
class ResumeSearchModule extends PureComponent {
  render() {
...
ResumeSearchModule.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ResumeSearchModule.displayName = 'ResumeSearchModule';

export default ResumeSearchModule;
