...
// Component import
import ResumeSearchModule from './ResumeSearchModule';
import ResumeSearchModuleReadme from './ResumeSearchModule.README.md';
...
const WrappedResumeSearchModule = StorybookComponentWrapperHOC(
  ResumeSearchModule
);

// React render function
const ResumeSearchModulePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedResumeSearchModule />
    </State>
  );
};
...
storiesOf('Search', module)
  ...
  .addWithChapters('Resume Search Module', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ResumeSearchModuleReadme,
            sectionFn: ResumeSearchModulePreviewRenderer
          }
        ]
      }
    ]
