...
// Component import
import JobSearchAdvanced from './JobSearchAdvanced';
import JobSearchAdvancedReadme from './JobSearchAdvanced.README.md';
...
const WrappedJobSearchAdvanced = StorybookComponentWrapperHOC(
  JobSearchAdvanced
);

// React render function
const JobSearchAdvancedPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobSearchAdvanced />
    </State>
  );
};
...
storiesOf('Search', module)
  ...
  .addWithChapters('Job Search Advanced Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobSearchAdvancedReadme,
            sectionFn: JobSearchAdvancedPreviewRenderer
          }
        ]
      }
    ]
