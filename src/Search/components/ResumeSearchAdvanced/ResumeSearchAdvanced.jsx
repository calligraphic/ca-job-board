...
class ResumeSearchAdvanced extends PureComponent {
  render() {
...
ResumeSearchAdvanced.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ResumeSearchAdvanced.displayName = 'ResumeSearchAdvanced';

export default ResumeSearchAdvanced;
