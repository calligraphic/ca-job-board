...
// Component import
import ResumeSearchAdvanced from './ResumeSearchAdvanced';
import ResumeSearchAdvancedReadme from './ResumeSearchAdvanced.README.md';
...
const WrappedResumeSearchAdvanced = StorybookComponentWrapperHOC(
  ResumeSearchAdvanced
);

// React render function
const ResumeSearchAdvancedPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedResumeSearchAdvanced />
    </State>
  );
};
...
storiesOf('Search', module)
  ...
  .addWithChapters('Resume Search Advanced Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ResumeSearchAdvancedReadme,
            sectionFn: ResumeSearchAdvancedPreviewRenderer
          }
        ]
      }
    ]
