...
// Component import
import ApplicationSearchAdvanced from './ApplicationSearchAdvanced';
import ApplicationSearchAdvancedReadme from './ApplicationSearchAdvanced.README.md';
...
const WrappedApplicationSearchAdvanced = StorybookComponentWrapperHOC(
  ApplicationSearchAdvanced
);

// React render function
const ApplicationSearchAdvancedPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedApplicationSearchAdvanced />
    </State>
  );
};
...
storiesOf('Search', module)
  ...
  .addWithChapters('Application Search Advanced Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ApplicationSearchAdvancedReadme,
            sectionFn: ApplicationSearchAdvancedPreviewRenderer
          }
        ]
      }
    ]
