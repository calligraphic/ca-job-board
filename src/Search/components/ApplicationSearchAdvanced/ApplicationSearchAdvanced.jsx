...
class ApplicationSearchAdvanced extends PureComponent {
  render() {
...
ApplicationSearchAdvanced.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ApplicationSearchAdvanced.displayName = 'ApplicationSearchAdvanced';

export default ApplicationSearchAdvanced;
