...
import ApplicationSearchModuleReadme from './ApplicationSearchModule.README.md';
...
const WrappedApplicationSearchModule = StorybookComponentWrapperHOC(
  ApplicationSearchModule
);

// React render function
const ApplicationSearchModulePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedApplicationSearchModule />
    </State>
  );
};
...
storiesOf('Search', module)
  ...
  .addWithChapters('Application Search Module Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ApplicationSearchModuleReadme,
            sectionFn: ApplicationSearchModulePreviewRenderer
          }
        ]
      }
    ]
