...
class ApplicationSearchModule extends PureComponent {
  render() {
...
ApplicationSearchModule.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ApplicationSearchModule.displayName = 'ApplicationSearchModule';

export default ApplicationSearchModule;
