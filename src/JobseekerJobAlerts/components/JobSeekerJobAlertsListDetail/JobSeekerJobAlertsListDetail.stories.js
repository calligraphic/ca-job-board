...
// Component import
import JobSeekerJobAlertsListDetail from './JobSeekerJobAlertsListDetail';
import JobSeekerJobAlertsListDetailReadme from './JobSeekerJobAlertsListDetail.README.md';
...
const WrappedJobSeekerJobAlertsListDetail = StorybookComponentWrapperHOC(
  JobSeekerJobAlertsListDetail
);

// React render function
const JobSeekerJobAlertsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobSeekerJobAlertsListDetail />
    </State>
  );
};
...
storiesOf('JobSeeker Job Alerts', module)
  ...
  .addWithChapters('Job Alerts List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobSeekerJobAlertsListDetailReadme,
            sectionFn: JobSeekerJobAlertsListDetailPreviewRenderer
          }
        ]
      }
    ]
