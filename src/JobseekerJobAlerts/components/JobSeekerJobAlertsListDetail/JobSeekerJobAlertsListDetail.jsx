...
class JobSeekerJobAlertsListDetail extends PureComponent {
  render() {
...
JobSeekerJobAlertsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobSeekerJobAlertsListDetail.displayName = 'JobSeekerJobAlertsListDetail';

export default JobSeekerJobAlertsListDetail;
