...
class JobSeekerJobAlertsEdit extends PureComponent {
  render() {
...
JobSeekerJobAlertsEdit.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobSeekerJobAlertsEdit.displayName = 'JobSeekerJobAlertsEdit';

export default JobSeekerJobAlertsEdit;
