...
class JobSeekerJobAlertsCreate extends PureComponent {
  render() {
...
JobSeekerJobAlertsCreate.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobSeekerJobAlertsCreate.displayName = 'JobSeekerJobAlertsCreate';

export default JobSeekerJobAlertsCreate;
