...
// Component import
import JobSeekerJobAlertsCreate from './JobSeekerJobAlertsCreate';
import JobSeekerJobAlertsCreateReadme from './JobSeekerJobAlertsCreate.README.md';
...
const WrappedJobSeekerJobAlertsCreate = StorybookComponentWrapperHOC(
  JobSeekerJobAlertsCreate
);

// React render function
const JobSeekerJobAlertsCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobSeekerJobAlertsCreate />
    </State>
  );
};
...
storiesOf('JobSeeker Job Alerts', module)
  ...
  .addWithChapters('Job Alerts Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobSeekerJobAlertsCreateReadme,
            sectionFn: JobSeekerJobAlertsCreatePreviewRenderer
          }
        ]
      }
    ]
