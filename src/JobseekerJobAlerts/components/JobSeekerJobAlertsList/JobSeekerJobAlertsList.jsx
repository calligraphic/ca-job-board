...
class JobSeekerJobAlertsList extends PureComponent {
  render() {
...
JobSeekerJobAlertsList.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobSeekerJobAlertsList.displayName = 'JobSeekerJobAlertsList';

export default JobSeekerJobAlertsList;
