...
class JobSeekerJobAlertsItem extends PureComponent {
  render() {
...
JobSeekerJobAlertsItem.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobSeekerJobAlertsItem.displayName = 'JobSeekerJobAlertsItem';

export default JobSeekerJobAlertsItem;
