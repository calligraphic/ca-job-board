...
// Component import
import JobSeekerJobAlertsConfig from './JobSeekerJobAlertsConfig';
import JobSeekerJobAlertsConfigReadme from './JobSeekerJobAlertsConfig.README.md';
...
const WrappedJobSeekerJobAlertsConfig = StorybookComponentWrapperHOC(
  JobSeekerJobAlertsConfig
);

// React render function
const JobSeekerJobAlertsConfigPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobSeekerJobAlertsConfig />
    </State>
  );
};
...
storiesOf('JobSeeker Job Alerts', module)
  ...
  .addWithChapters('Job Alerts Config Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobSeekerJobAlertsConfigReadme,
            sectionFn: JobSeekerJobAlertsConfigPreviewRenderer
          }
        ]
      }
    ]
