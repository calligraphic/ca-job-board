...
// Custom keymap to override basic keymap containing bindings
const keys = {
  'Mod-z': undo,
  'Shift-Mod-z': redo,
...
// Use a basic keymap containing bindings if no custom binding provided here
...
export default keyMapPlugin(keys);
