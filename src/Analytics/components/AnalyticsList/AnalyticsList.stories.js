...
import AnalyticsListReadme from './AnalyticsList.README.md';
...
const WrappedAnalyticsList = StorybookComponentWrapperHOC(AnalyticsList);

// React render function
const AnalyticsListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAnalyticsList />
    </State>
  );
};
...
storiesOf('Analytics', module)
  ...
  .addWithChapters('Analytics List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AnalyticsListReadme,
            sectionFn: AnalyticsListPreviewRenderer
          }
        ]
      }
    ]
