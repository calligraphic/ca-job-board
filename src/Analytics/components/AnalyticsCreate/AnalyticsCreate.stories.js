...
import AnalyticsCreateReadme from './AnalyticsCreate.README.md';
...
const WrappedAnalyticsCreate = StorybookComponentWrapperHOC(AnalyticsCreate);

// React render function
const AnalyticsCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAnalyticsCreate />
    </State>
  );
};
...
storiesOf('Analytics', module)
  ...
  .addWithChapters('Analytics Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AnalyticsCreateReadme,
            sectionFn: AnalyticsCreatePreviewRenderer
          }
        ]
      }
    ]
