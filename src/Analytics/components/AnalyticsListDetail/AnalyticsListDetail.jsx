...
class AnalyticsListDetail extends PureComponent {
  render() {
...
AnalyticsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
AnalyticsListDetail.displayName = 'AnalyticsListDetail';

export default AnalyticsListDetail;
