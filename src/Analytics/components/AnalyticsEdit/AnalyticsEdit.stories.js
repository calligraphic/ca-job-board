...
import AnalyticsEditReadme from './AnalyticsEdit.README.md';
...
const WrappedAnalyticsEdit = StorybookComponentWrapperHOC(AnalyticsEdit);

// React render function
const AnalyticsEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAnalyticsEdit />
    </State>
  );
};
...
storiesOf('Analytics', module)
  ...
  .addWithChapters('Analytics Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AnalyticsEditReadme,
            sectionFn: AnalyticsEditPreviewRenderer
          }
        ]
      }
    ]
