...
import AnalyticsItemReadme from './AnalyticsItem.README.md';
...
const WrappedAnalyticsItem = StorybookComponentWrapperHOC(AnalyticsItem);

// React render function
const AnalyticsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedAnalyticsItem />
    </State>
  );
};
...
storiesOf('Analytics', module)
  ...
  .addWithChapters('Analytics Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: AnalyticsItemReadme,
            sectionFn: AnalyticsItemPreviewRenderer
          }
        ]
      }
    ]
