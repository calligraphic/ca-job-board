...
// Component import
import ShoppingCartCreate from './ShoppingCartCreate';
import ShoppingCartCreateReadme from './ShoppingCartCreate.README.md';
...
const WrappedShoppingCartCreate = StorybookComponentWrapperHOC(
  ShoppingCartCreate
);

// React render function
const ShoppingCartCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedShoppingCartCreate />
    </State>
  );
};
...
storiesOf('Shopping Cart', module)
  ...
  .addWithChapters('Shopping Cart Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ShoppingCartCreateReadme,
            sectionFn: ShoppingCartCreatePreviewRenderer
          }
        ]
      }
    ]
