...
// Component import
import ShoppingCartListDetail from './ShoppingCartListDetail';
import ShoppingCartListDetailReadme from './ShoppingCartListDetail.README.md';
...
const WrappedShoppingCartListDetail = StorybookComponentWrapperHOC(
  ShoppingCartListDetail
);

// React render function
const ShoppingCartListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedShoppingCartListDetail />
    </State>
  );
};
...
storiesOf('Shopping Cart', module)
  ...
  .addWithChapters('Shopping Cart List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ShoppingCartListDetailReadme,
            sectionFn: ShoppingCartListDetailPreviewRenderer
          }
        ]
      }
    ]
