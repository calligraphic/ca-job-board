...
class ShoppingCartListDetail extends PureComponent {
  render() {
...
ShoppingCartListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
ShoppingCartListDetail.displayName = 'ShoppingCartListDetail';

export default ShoppingCartListDetail;
