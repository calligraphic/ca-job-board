...
import ShoppingCartItemReadme from './ShoppingCartItem.README.md';
...
const WrappedShoppingCartItem = StorybookComponentWrapperHOC(ShoppingCartItem);

// React render function
const ShoppingCartItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedShoppingCartItem />
    </State>
  );
};
...
storiesOf('Shopping Cart', module)
  ...
  .addWithChapters('Shopping Cart Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ShoppingCartItemReadme,
            sectionFn: ShoppingCartItemPreviewRenderer
          }
        ]
      }
    ]
