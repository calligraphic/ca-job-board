...
// Component import
import ShoppingCartEdit from './ShoppingCartEdit';
import ShoppingCartEditReadme from './ShoppingCartEdit.README.md';
...
const WrappedShoppingCartEdit = StorybookComponentWrapperHOC(ShoppingCartEdit);

// React render function
const ShoppingCartEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedShoppingCartEdit />
    </State>
  );
};
...
storiesOf('Shopping Cart', module)
  ...
  .addWithChapters('Shopping Cart Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ShoppingCartEditReadme,
            sectionFn: ShoppingCartEditPreviewRenderer
          }
        ]
      }
    ]
