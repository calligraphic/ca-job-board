...
import ShoppingCartListReadme from './ShoppingCartList.README.md';
...
const WrappedShoppingCartList = StorybookComponentWrapperHOC(ShoppingCartList);

// React render function
const ShoppingCartListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedShoppingCartList />
    </State>
  );
};
...
storiesOf('Shopping Cart', module)
  ...
  .addWithChapters('Shopping Cart List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: ShoppingCartListReadme,
            sectionFn: ShoppingCartListPreviewRenderer
          }
        ]
      }
    ]
