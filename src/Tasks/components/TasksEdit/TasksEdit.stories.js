...
import TasksEditReadme from './TasksEdit.README.md';
...
const WrappedTasksEdit = StorybookComponentWrapperHOC(TasksEdit);

// React render function
const TasksEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedTasksEdit />
    </State>
...
storiesOf('Tasks', module)
  ...
  .addWithChapters('Tasks Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: TasksEditReadme,
            sectionFn: TasksEditPreviewRenderer
          }
        ]
      }
    ]
