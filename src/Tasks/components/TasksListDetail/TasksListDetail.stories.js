...
import TasksListDetailReadme from './TasksListDetail.README.md';
...
const WrappedTasksListDetail = StorybookComponentWrapperHOC(TasksListDetail);

// React render function
const TasksListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedTasksListDetail />
    </State>
  );
};
...
storiesOf('Tasks', module)
  ...
  .addWithChapters('Tasks List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: TasksListDetailReadme,
            sectionFn: TasksListDetailPreviewRenderer
          }
        ]
      }
    ]
