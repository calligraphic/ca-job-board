...
import TasksCreateReadme from './TasksCreate.README.md';
...
const WrappedTasksCreate = StorybookComponentWrapperHOC(TasksCreate);

// React render function
const TasksCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedTasksCreate />
    </State>
...
storiesOf('Tasks', module)
  ...
  .addWithChapters('Tasks Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: TasksCreateReadme,
            sectionFn: TasksCreatePreviewRenderer
          }
        ]
      }
    ]
