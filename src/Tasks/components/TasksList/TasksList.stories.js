...
import TasksListReadme from './TasksList.README.md';
...
const WrappedTasksList = StorybookComponentWrapperHOC(TasksList);

// React render function
const TasksListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedTasksList />
    </State>
...
storiesOf('Tasks', module)
  ...
  .addWithChapters('Tasks List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: TasksListReadme,
            sectionFn: TasksListPreviewRenderer
          }
        ]
      }
    ]
