...
// Component import
import SubscriptionsAdminEdit from './SubscriptionsAdminEdit';
import SubscriptionsAdminEditReadme from './SubscriptionsAdminEdit.README.md';
...
const WrappedSubscriptionsAdminEdit = StorybookComponentWrapperHOC(
  SubscriptionsAdminEdit
);

// React render function
const SubscriptionsAdminEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSubscriptionsAdminEdit />
    </State>
  );
};
...
storiesOf('Subscriptions', module)
  ...
  .addWithChapters('Subscriptions Admin Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SubscriptionsAdminEditReadme,
            sectionFn: SubscriptionsAdminEditPreviewRenderer
          }
        ]
      }
    ]
