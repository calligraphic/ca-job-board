...
class SubscriptionsAdminEdit extends PureComponent {
  render() {
...
SubscriptionsAdminEdit.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
SubscriptionsAdminEdit.displayName = 'SubscriptionsAdminEdit';

export default SubscriptionsAdminEdit;
