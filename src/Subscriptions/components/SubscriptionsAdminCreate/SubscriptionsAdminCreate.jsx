...
class SubscriptionsAdminCreate extends PureComponent {
  render() {
...
SubscriptionsAdminCreate.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
SubscriptionsAdminCreate.displayName = 'SubscriptionsAdminCreate';

export default SubscriptionsAdminCreate;
