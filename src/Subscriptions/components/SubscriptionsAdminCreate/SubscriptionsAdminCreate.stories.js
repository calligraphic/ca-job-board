...
// Component import
import SubscriptionsAdminCreate from './SubscriptionsAdminCreate';
import SubscriptionsAdminCreateReadme from './SubscriptionsAdminCreate.README.md';
...
const WrappedSubscriptionsAdminCreate = StorybookComponentWrapperHOC(
  SubscriptionsAdminCreate
);

// React render function
const SubscriptionsAdminCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSubscriptionsAdminCreate />
    </State>
  );
};

storiesOf('Subscriptions', module)
  .addDecorator(withKnobs)
  .addDecorator((story, context) =>
    withNotes(notesPanelContent)(story)(context)
  )
  .addWithChapters('Subscriptions Admin Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SubscriptionsAdminCreateReadme,
            sectionFn: SubscriptionsAdminCreatePreviewRenderer
          }
        ]
      }
    ]
