...
import SubscriptionsItemReadme from './SubscriptionsItem.README.md';
...
const WrappedSubscriptionsItem = StorybookComponentWrapperHOC(
  SubscriptionsItem
);

// React render function
const SubscriptionsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSubscriptionsItem />
    </State>
  );
};
...
storiesOf('Subscriptions', module)
  ...
  .addWithChapters('Subscriptions Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SubscriptionsItemReadme,
            sectionFn: SubscriptionsItemPreviewRenderer
          }
        ]
      }
    ]
