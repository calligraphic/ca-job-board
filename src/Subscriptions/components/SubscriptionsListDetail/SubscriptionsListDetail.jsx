...
class SubscriptionsListDetail extends PureComponent {
  render() {
...
SubscriptionsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
SubscriptionsListDetail.displayName = 'SubscriptionsListDetail';

export default SubscriptionsListDetail;
