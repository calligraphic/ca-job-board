...
// Component import
import SubscriptionsListDetail from './SubscriptionsListDetail';
import SubscriptionsListDetailReadme from './SubscriptionsListDetail.README.md';
...
const WrappedSubscriptionsListDetail = StorybookComponentWrapperHOC(
  SubscriptionsListDetail
);

// React render function
const SubscriptionsListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSubscriptionsListDetail />
    </State>
  );
};
...
storiesOf('Subscriptions', module)
  ...
  .addWithChapters('Subscriptions List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SubscriptionsListDetailReadme,
            sectionFn: SubscriptionsListDetailPreviewRenderer
          }
        ]
      }
    ]
