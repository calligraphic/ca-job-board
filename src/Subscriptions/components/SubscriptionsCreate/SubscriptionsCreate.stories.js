...
import SubscriptionsCreateReadme from './SubscriptionsCreate.README.md';
...
const WrappedSubscriptionsCreate = StorybookComponentWrapperHOC(
  SubscriptionsCreate
);

// React render function
const SubscriptionsCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSubscriptionsCreate />
    </State>
  );
};
...
storiesOf('Subscriptions', module)
  ...
  .addWithChapters('Subscriptions Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SubscriptionsCreateReadme,
            sectionFn: SubscriptionsCreatePreviewRenderer
          }
        ]
      }
    ]
