...
import SubscriptionsListReadme from './SubscriptionsList.README.md';
...
const WrappedSubscriptionsList = StorybookComponentWrapperHOC(
  SubscriptionsList
);

// React render function
const SubscriptionsListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedSubscriptionsList />
    </State>
  );
};
...
storiesOf('Subscriptions', module)
  ...
  .addWithChapters('Subscriptions List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: SubscriptionsListReadme,
            sectionFn: SubscriptionsListPreviewRenderer
          }
        ]
      }
    ]
