...
class JobSeekerProfileListDetail extends PureComponent {
  render() {
...
JobSeekerProfileListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
JobSeekerProfileListDetail.displayName = 'JobSeekerProfileListDetail';

export default JobSeekerProfileListDetail;
