...
// Component import
import JobSeekerProfileCreate from './JobSeekerProfileCreate';
import JobSeekerProfileCreateReadme from './JobSeekerProfileCreate.README.md';
...
const WrappedJobSeekerProfileCreate = StorybookComponentWrapperHOC(
  JobSeekerProfileCreate
);

// React render function
const JobSeekerProfileCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobSeekerProfileCreate />
    </State>
  );
};
...
storiesOf('Job Seeker Profiles', module)
  ...
  .addWithChapters('Job Seeker Profile Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobSeekerProfileCreateReadme,
            sectionFn: JobSeekerProfileCreatePreviewRenderer
          }
        ]
      }
    ]
