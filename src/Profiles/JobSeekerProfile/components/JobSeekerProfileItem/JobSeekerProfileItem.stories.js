...
import JobSeekerProfileItemReadme from './JobSeekerProfileItem.README.md';
...
const WrappedJobSeekerProfileItem = StorybookComponentWrapperHOC(
  JobSeekerProfileItem
);

// React render function
const JobSeekerProfileItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobSeekerProfileItem />
    </State>
  );
};
...
storiesOf('Job Seeker Profiles', module)
  ...
  .addWithChapters('Job Seeker Profile Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobSeekerProfileItemReadme,
            sectionFn: JobSeekerProfileItemPreviewRenderer
          }
        ]
      }
    ]
