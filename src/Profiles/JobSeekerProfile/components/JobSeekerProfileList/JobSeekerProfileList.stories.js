...
// Component import
import JobSeekerProfileList from './JobSeekerProfileList';
import JobSeekerProfileListReadme from './JobSeekerProfileList.README.md';
...
const WrappedJobSeekerProfileList = StorybookComponentWrapperHOC(
  JobSeekerProfileList
);

// React render function
const JobSeekerProfileListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedJobSeekerProfileList />
    </State>
  );
};
...
storiesOf('Job Seeker Profiles', module)
  ...
  .addWithChapters('Job Seeker Profile List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: JobSeekerProfileListReadme,
            sectionFn: JobSeekerProfileListPreviewRenderer
          }
        ]
      }
    ]
