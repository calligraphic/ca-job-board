...
// Component import
import EmployerProfileCreate from './EmployerProfileCreate';
import EmployerProfileCreateReadme from './EmployerProfileCreate.README.md';
...
const WrappedEmployerProfileCreate = StorybookComponentWrapperHOC(
  EmployerProfileCreate
);

// React render function
const EmployerProfileCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerProfileCreate />
    </State>
  );
};
...
storiesOf('Employer Profiles', module)
  ...
  .addWithChapters('Employer Profile Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerProfileCreateReadme,
            sectionFn: EmployerProfileCreatePreviewRenderer
          }
        ]
      }
    ]
