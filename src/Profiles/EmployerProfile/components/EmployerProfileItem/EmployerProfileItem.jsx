...
class EmployerProfileItem extends PureComponent {
  render() {
...
EmployerProfileItem.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerProfileItem.displayName = 'EmployerProfileItem';

export default EmployerProfileItem;
