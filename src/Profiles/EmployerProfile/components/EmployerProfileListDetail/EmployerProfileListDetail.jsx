...
class EmployerProfileListDetail extends PureComponent {
  render() {
...
EmployerProfileListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerProfileListDetail.displayName = 'EmployerProfileListDetail';

export default EmployerProfileListDetail;
