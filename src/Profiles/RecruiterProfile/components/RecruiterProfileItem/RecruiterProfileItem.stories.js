...
// Component import
import RecruiterProfileItem from './RecruiterProfileItem';
import RecruiterProfileItemReadme from './RecruiterProfileItem.README.md';
...
const WrappedRecruiterProfileItem = StorybookComponentWrapperHOC(
  RecruiterProfileItem
);

// React render function
const RecruiterProfileItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRecruiterProfileItem />
    </State>
  );
};
...
storiesOf('Recruiter Profiles', module)
  ...
  .addWithChapters('Recruiter Profile Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RecruiterProfileItemReadme,
            sectionFn: RecruiterProfileItemPreviewRenderer
          }
        ]
      }
    ]
