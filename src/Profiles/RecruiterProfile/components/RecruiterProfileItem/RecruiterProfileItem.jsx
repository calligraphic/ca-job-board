...
class RecruiterProfileItem extends PureComponent {
  render() {
...
RecruiterProfileItem.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
RecruiterProfileItem.displayName = 'RecruiterProfileItem';

export default RecruiterProfileItem;
