...
// Component import
import RecruiterProfileListDetail from './RecruiterProfileListDetail';
import RecruiterProfileListDetailReadme from './RecruiterProfileListDetail.README.md';
...
const WrappedRecruiterProfileListDetail = StorybookComponentWrapperHOC(
  RecruiterProfileListDetail
);

// React render function
const RecruiterProfileListDetailPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRecruiterProfileListDetail />
    </State>
  );
};
...
storiesOf('Recruiter Profiles', module)
  ...
  .addWithChapters('Recruiter Profile List Detail Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RecruiterProfileListDetailReadme,
            sectionFn: RecruiterProfileListDetailPreviewRenderer
          }
        ]
      }
    ]
