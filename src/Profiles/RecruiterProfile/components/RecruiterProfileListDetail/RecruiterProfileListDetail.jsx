...
class RecruiterProfileListDetail extends PureComponent {
  render() {
...
RecruiterProfileListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
RecruiterProfileListDetail.displayName = 'RecruiterProfileListDetail';

export default RecruiterProfileListDetail;
