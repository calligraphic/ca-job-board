...
import RecruiterProfileEditReadme from './RecruiterProfileEdit.README.md';
...
const WrappedRecruiterProfileEdit = StorybookComponentWrapperHOC(
  RecruiterProfileEdit
);

// React render function
const RecruiterProfileEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRecruiterProfileEdit />
    </State>
  );
};
...
storiesOf('Recruiter Profiles', module)
  ...
  .addWithChapters('Recruiter Profile Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RecruiterProfileEditReadme,
            sectionFn: RecruiterProfileEditPreviewRenderer
          }
        ]
      }
    ]
