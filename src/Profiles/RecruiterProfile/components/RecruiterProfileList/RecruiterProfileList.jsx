...
class RecruiterProfileList extends PureComponent {
  render() {
...
RecruiterProfileList.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
RecruiterProfileList.displayName = 'RecruiterProfileList';

export default RecruiterProfileList;
