...
// Component import
import RecruiterProfileCreate from './RecruiterProfileCreate';
import RecruiterProfileCreateReadme from './RecruiterProfileCreate.README.md';
...
const WrappedRecruiterProfileCreate = StorybookComponentWrapperHOC(
  RecruiterProfileCreate
);

// React render function
const RecruiterProfileCreatePreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedRecruiterProfileCreate />
    </State>
  );
};
...
storiesOf('Recruiter Profiles', module)
  ...
  .addWithChapters('Recruiter Profile Create Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: RecruiterProfileCreateReadme,
            sectionFn: RecruiterProfileCreatePreviewRenderer
          }
        ]
      }
    ]
