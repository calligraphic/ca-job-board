...
class EmployerResumeAlertsListDetail extends PureComponent {
  render() {
...
EmployerResumeAlertsListDetail.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerResumeAlertsListDetail.displayName = 'EmployerResumeAlertsListDetail';

export default EmployerResumeAlertsListDetail;
