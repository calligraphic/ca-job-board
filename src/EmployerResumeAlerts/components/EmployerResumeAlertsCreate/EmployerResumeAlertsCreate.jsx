...
class EmployerResumeAlertsCreate extends PureComponent {
  render() {
...
EmployerResumeAlertsCreate.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerResumeAlertsCreate.displayName = 'EmployerResumeAlertsCreate';

export default EmployerResumeAlertsCreate;
