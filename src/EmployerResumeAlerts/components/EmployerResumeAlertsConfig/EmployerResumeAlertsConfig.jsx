...
class EmployerResumeAlertsConfig extends PureComponent {
  render() {
...
EmployerResumeAlertsConfig.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerResumeAlertsConfig.displayName = 'EmployerResumeAlertsConfig';

export default EmployerResumeAlertsConfig;
