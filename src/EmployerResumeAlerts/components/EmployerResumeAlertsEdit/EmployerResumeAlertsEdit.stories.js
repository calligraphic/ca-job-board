...
// Component import
import EmployerResumeAlertsEdit from './EmployerResumeAlertsEdit';
import EmployerResumeAlertsEditReadme from './EmployerResumeAlertsEdit.README.md';
...
const WrappedEmployerResumeAlertsEdit = StorybookComponentWrapperHOC(
  EmployerResumeAlertsEdit
);

// React render function
const EmployerResumeAlertsEditPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerResumeAlertsEdit />
    </State>
  );
};
...
storiesOf('Employer Resume Alerts', module)
  ...
  .addWithChapters('Resume Alerts Edit Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerResumeAlertsEditReadme,
            sectionFn: EmployerResumeAlertsEditPreviewRenderer
          }
        ]
      }
    ]
