...
class EmployerResumeAlertsEdit extends PureComponent {
  render() {
...
EmployerResumeAlertsEdit.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerResumeAlertsEdit.displayName = 'EmployerResumeAlertsEdit';

export default EmployerResumeAlertsEdit;
