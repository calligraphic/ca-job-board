...
// Component import
import EmployerResumeAlertsList from './EmployerResumeAlertsList';
import EmployerResumeAlertsListReadme from './EmployerResumeAlertsList.README.md';
...
const WrappedEmployerResumeAlertsList = StorybookComponentWrapperHOC(
  EmployerResumeAlertsList
);

// React render function
const EmployerResumeAlertsListPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerResumeAlertsList />
    </State>
  );
};
...
storiesOf('Employer Resume Alerts', module)
  ...
  .addWithChapters('Resume Alerts List Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerResumeAlertsListReadme,
            sectionFn: EmployerResumeAlertsListPreviewRenderer
          }
        ]
      }
    ]
