...
class EmployerResumeAlertsList extends PureComponent {
  render() {
...
EmployerResumeAlertsList.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerResumeAlertsList.displayName = 'EmployerResumeAlertsList';

export default EmployerResumeAlertsList;
