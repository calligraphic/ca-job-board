...
// Component import
import EmployerResumeAlertsItem from './EmployerResumeAlertsItem';
import EmployerResumeAlertsItemReadme from './EmployerResumeAlertsItem.README.md';
...
const WrappedEmployerResumeAlertsItem = StorybookComponentWrapperHOC(
  EmployerResumeAlertsItem
);

// React render function
const EmployerResumeAlertsItemPreviewRenderer = () => {
  return (
    <State store={store}>
      <WrappedEmployerResumeAlertsItem />
    </State>
  );
};
...
storiesOf('Employer Resume Alerts', module)
  ...
  .addWithChapters('Resume Alerts Item Views', {
    subtitle: null,
    info: null,
    chapters: [
      {
        ...
        sections: [
          {
            title: null,
            subtitle: null,
            info: EmployerResumeAlertsItemReadme,
            sectionFn: EmployerResumeAlertsItemPreviewRenderer
          }
        ]
      }
    ]
