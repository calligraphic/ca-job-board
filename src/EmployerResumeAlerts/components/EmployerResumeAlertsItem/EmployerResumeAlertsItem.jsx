...
class EmployerResumeAlertsItem extends PureComponent {
  render() {
...
EmployerResumeAlertsItem.propTypes = {
  title: PropTypes.string.isRequired,
  description: PropTypes.string.isRequired
};

// Keep Storybook from losing reference to component name on static compile
EmployerResumeAlertsItem.displayName = 'EmployerResumeAlertsItem';

export default EmployerResumeAlertsItem;
